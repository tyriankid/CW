namespace Hidistro.Membership.Context
{
    ...
    public class SiteSettings
    {
        ...
        public void WriteToXml(XmlDocument doc)
        {
            ...
            SetNodeValue(doc, root, "CurrentDomain", this.CurrentDomain);
