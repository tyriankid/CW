namespace Hidistro.Entities.Orders
{
    ...
    public class LineItemInfo
    {
        ...
        {
            return (this.ItemAdjustedPrice * (this.Quantity - this.GiveQuantity) );
        }
        ...
        {
            return ((this.ItemAdjustedPrice - this.ItemCostPrice) * (this.Quantity - this.GiveQuantity));
        }
        ...
        {
            return (this.ItemCostPrice * (this.Quantity - this.GiveQuantity));
        }
        ...
        {
            return ((this.ItemAdjustedPrice - this.ItemAdjustedPrice * rate) * (this.Quantity - this.GiveQuantity));
        }
