namespace Hidistro.SaleSystem.Vshop
{
    ...
    public static class ProductBrowser
    {
        ...
        public static DataTable GetProducts(MemberInfo member, int? topicId, int? categoryId, int? valueId, string keyWord, int pageNumber, int maxNum, out int total, string sort, string order, string swr = "", int rangeType = 0,string fgsId="")
        {
            ...
            return new ProductBrowseDao().GetProductsRange(member, topicId, categoryId, valueId, Globals.GetCurrentDistributorId(), keyWord, pageNumber, maxNum, out total, sort, order == "asc", productRanage, swr, rangeType,fgsId);
        }
        ...
        /// </summary>
        public static DataTable GetProductsEx(MemberInfo member, int? topicId, int? categoryId, string keyWord, int pageNumber, int maxNum, out int total, string sort, string order, ProductInfo.ProductRanage productRanage,string  fgsId="")
        {
            ...
            {
                table = new ProductBrowseDao().GetProductsEx(member, topicId, categoryId, currentDistributorId, keyWord, pageNumber, maxNum, out toal, sort, order == "asc", productRanage, fgsId);
            }
            total = toal;
            return table;
        }
        ...
        /// <returns></returns>
        public static int FindDistributorUserNoReply(int DistributorUserId)
        {
            return new ProductConsultationDao().FindDistributorUserNoReply(DistributorUserId);
        }
        ...
        /// <param name="DistributorUserId"></param>
        /// <returns></returns>
        public static int FindDistributorUserReply(int DistributorUserId)
        {
            return new ProductConsultationDao().FindDistributorUserReply(DistributorUserId);
        }
        ...
        */
        ...
        /// <returns></returns>
        public static DataTable GetProducts(string where)
        {
            return new ProductBrowseDao().GetProducts(where);
        }
        /// <summary>
        /// 商品维护提醒 2017-8-9 yk
        /// </summary>
        ...
        {
             Messenger.OrderPaymentToProductMaintainRemind(userId, orderId, ItemDescription, remarkeStr);
        }
    }
}
