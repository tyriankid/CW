namespace Hidistro.SaleSystem.Vshop
{
    ...
    public static class TradeHelper
    {
        ...
        //    if (order.LineItems.ContainsKey(skuId))
        //    {
        //        return order.GetCanRefundAmount(skuId);
        //    }
        //    return 0M;
        //}
        ...
        //    {
        //        num += (dao.GetProductReferralDeduct(info.ProductId) * info.GetSubTotal()) / 100M;
        //    }
        //    return num;
        //}
        ...
        //    foreach (LineItemInfo info in order.LineItems.Values)
        //    {
        //        num += (dao.GetProductSubMemberDeduct(info.ProductId) * info.GetSubTotal()) / 100M;
        //    }
        //    return num;
        //}
        ...
        //    foreach (LineItemInfo info in order.LineItems.Values)
        //    {
        //        num += (dao.GetProductSubReferralDeduct(info.ProductId) * info.GetSubTotal()) / 100M;
        //    }
        //    return num;
        //}
        ...
        public static string GetReturnsIdByOrderId(string orderid)
        {
            return new ReturnDao().GetReturnsIdByOrderId(orderid);
        }
