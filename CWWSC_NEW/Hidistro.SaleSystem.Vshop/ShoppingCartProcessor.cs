namespace Hidistro.SaleSystem.Vshop
{
    ...
    public static class ShoppingCartProcessor
    {
        ...
        public static ShoppingCartInfo GetGroupBuyShoppingCart(int groupbuyId, string productSkuId, int buyAmount)
        {
            ...
            shoppingCartItemInfo.IsfreeShipping = info3.IsfreeShipping;
            ...
            shoppingCartItemInfo.ProductSource = info3.ProductSource;//商品来源
            shoppingCartItemInfo.SupplierId = info3.SupplierId;//供应商Id
            shoppingCartItemInfo.FilialeId = info3.FilialeId;//供应商Id
        ...
        */
        ...
        public static ShoppingCartInfo GetCountDownShoppingCart(string productSkuId, int buyAmount)
        {
            ...
            info4 = new ShoppingCartItemInfo
            {
                ...
                //wt修改
                ProductSource = info2.ProductSource,
                SupplierId = info2.SupplierId,
                //分公司ID，线下订单使用
                FilialeId = info2.FilialeId
            };
