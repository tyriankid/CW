namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    [ParseChildren(true)]
    public class VProductServiceDetails : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            //定义价格显示值对象
            string strPrice = "¥" + product.MinSalePrice.ToString("F2");
            if (isbackshow != "1")
            {
                //验证是否存在内购价格
                if (product.MinNeigouPrice > 0)
                {
                    //判断是否为内购门店
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                this.SkinName = "Skin-VProductServiceDetails.html";
            }
            base.OnInit(e);
        }
    }
