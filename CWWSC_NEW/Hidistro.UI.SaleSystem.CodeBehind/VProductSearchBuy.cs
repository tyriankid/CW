namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VProductSearchBuy : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            //}
            /******Start 2017-07-04 修改********/
            int ReferralUserId = Globals.GetCurrentDistributorId();
            /******End ********/
            ...
            switch (Hidistro.Core.SettingsManager.GetMasterSettings(true).VTheme.ToLower())
            {
                ...
                case "hotel":
                    ...
                    //获取手机端所有商品的分类
                    DataTable dt = CategoryBrowser.GetCategoriesByRange(2);//CategoryBrowser.GetCategoriesRange(ProductInfo.ProductRanage.NormalSelect);
                    ...
                    if (categoryId == 0)
                    {
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            dt2 = ProductBrowser.GetProducts(MemberProcessor.GetCurrentMember(), null, FirstCategoryID, null, this.keyWord, 1, 20, out total, "ShowSaleCounts", "desc", "", 2);
                        }
                    }
                    else
                    {
                        dt2 = ProductBrowser.GetProducts(MemberProcessor.GetCurrentMember(), null, categoryId, null, this.keyWord, 1, 20, out total, "ShowSaleCounts", "desc", "", 2);
                    }
