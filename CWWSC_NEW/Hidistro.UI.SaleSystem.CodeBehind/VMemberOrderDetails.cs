namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VMemberOrderDetails : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            this.litReceipt = (Literal)this.FindControl("litReceipt");//发票提示
            ...
            if (orderInfo.OrderStatus == OrderStatus.Finished)
            {
                ...
                {
                    this.litReceipt.Text = "<span>创维商品统一电子发票下载地址：<a href='http://dzfp.skyworth.com/dzfp/index.aspx'>http://dzfp.skyworth.com/dzfp/index.aspx</a></br>提示：根据订单号下载</span>";
                }
                if (orderInfo.OrderSource == 2)
                {
                    this.litReceipt.Text = "<span><a href=\"javascript:getFp('" + this.orderId + "');\">点击下载</a></span>";
                }
            }
            else
                this.litReceipt.Text = "订单未完成，无发票信息";
