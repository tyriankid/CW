namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VCutDownDetail : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            {
                this.litItemParams.Text = string.Concat(new object[] { str3, "|", masterSettings.GoodsName, "|", masterSettings.GoodsDescription, "$", Globals.HostPath(HttpContext.Current.Request.Url), currentMember.UserHead, "|", "快来砍价!", "|", currentProduct.ProductName + "最低可以砍到" + cutDown.MinPrice + "元!还不快行动!", "|", HttpContext.Current.Request.Url });
            }
