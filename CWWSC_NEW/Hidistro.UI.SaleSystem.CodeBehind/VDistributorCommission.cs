namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VDistributorCommission : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            /******2017-07-04修改*******/
            int dzUserId = Globals.GetCurrentMemberUserId();//当前用户ID，  如果是店员则取店长UserID
            bool isDy = false;//是否店员
            ...
            if (userIdDistributors == null)
            {
                ...
                if (disSalesinfo != null && disSalesinfo.DsID != Guid.Empty)
                {
                    isDy = true;
                    //当前登录为【店员】
                    dzUserId = disSalesinfo.DisUserId;//店长UserID
            ...
            if ((userIdDistributors != null) && (userIdDistributors.UserId > 0))
            {
                ...
                if (!isDy)
                {
                    ...
                    MemberInfo currentMember = MemberProcessor.GetMember(dzUserId);
                    ...
                    this.hyrequest.Visible = false;//店员隐藏
                //明细列表
