namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VMyProducts : VWeiXinOAuthTemplatedWebControl
    {
        ...
        private void DataBindSoruce()
        {
            ...
            this.rpChooseProducts.DataSource = ProductBrowser.GetProductsEx(memberinfo, null, new int?(this.categoryId), this.keyWord, 1, 0x2710, out num, "DisplaySequence", "desc", productRanage);
