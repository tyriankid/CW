namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VRequestReturn : VshopTemplatedWebControl
    {
        ...
        private HtmlInputHidden hidDiscountAmount;
        ...
        protected override void AttachChildControls()
        {
            ...
            this.hidDiscountAmount = (HtmlInputHidden)this.FindControl("DiscountAmount");
            ...
            this.hidDiscountAmount.Value = orderInfo.DiscountAmount.ToString("0.00");
            if (orderInfo == null)
            {
