namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VGroupBuyProductDetail : VshopTemplatedWebControl
    {
        ...
        private void SetControlsValue(int groupbuyId)
        {
            ...
            this.litItemParams.Text = string.Concat(new object[] { str3, "|", masterSettings.GoodsName, "|", masterSettings.GoodsDescription, "$", Globals.HostPath(HttpContext.Current.Request.Url), product.ImageUrl1, "|", "团购活动 - " + this.litProdcutName.Text, "|", product.ShortDescription, "|", strUrl });
        }
    }
}
