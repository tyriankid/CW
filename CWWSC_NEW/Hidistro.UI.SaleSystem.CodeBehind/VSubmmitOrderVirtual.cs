namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    [ParseChildren(true)]
    public class VSubmmitOrderVirtual : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            //{
                ...
                //this.litAddReceipt.Text = " href='/Vshop/AddReceipt.aspx?returnUrl=" + Globals.UrlEncode(HttpContext.Current.Request.Url.ToString()) + "'";
        ...
        /// <summary>
        /// 得到满减价格，2017-08-14修改，满足满减活动直接与商品关联
        /// </summary>
        ...
        public decimal DiscountMoney(IList<ShoppingCartItemInfo> infoList)
        {
            ...
            for (int i = 0; i < type.Rows.Count; i++)
            {
                ...
                {
                    //2017-08-14 修改检验满减活动，不是原分类上验证，改为商品验证
                    ...
                    if (info.ProductId > 0 && int.Parse(type.Rows[i]["ActivitiesType"].ToString()) == info.ProductId)
                    {
                        num5 += info.SubTotal;
                    }
                }
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                this.SkinName = "Skin-VSubmmitOrderVirtual.html";
            }
            base.OnInit(e);
        }
