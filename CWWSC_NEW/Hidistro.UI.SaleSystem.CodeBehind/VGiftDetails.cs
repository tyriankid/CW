namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VGiftDetails : VshopTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            this.litItemParams.Text = string.Concat(new object[] { str3, "|", masterSettings.GoodsName, "|", masterSettings.GoodsDescription, "$", Globals.HostPath(HttpContext.Current.Request.Url), gift.ImageUrl, "|", gift.Name, "|", gift.Title, "|", strUrl });
