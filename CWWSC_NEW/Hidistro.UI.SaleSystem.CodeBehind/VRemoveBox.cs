namespace Hidistro.UI.SaleSystem.CodeBehind
{
    ...
    public class VRemoveBox : VWeiXinOAuthTemplatedWebControl
    {
        ...
        protected override void AttachChildControls()
        {
            ...
            //}
            if (lotteryActivity.StartTime < DateTime.Now)
            {
                if (DateTime.Now < lotteryActivity.EndTime)
                {
                    ...
                    this.Page.ClientScript.RegisterStartupScript(base.GetType(), "myscript", "<script>$(function(){alert_h(\"对不起，活动已经结束！\");});</script>");
            }
            else
                this.Page.ClientScript.RegisterStartupScript(base.GetType(), "myscript", "<script>$(function(){alert_h(\"对不起，活动还未开始！\");});</script>");
        }
