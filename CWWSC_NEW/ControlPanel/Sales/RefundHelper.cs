namespace Hidistro.ControlPanel.Sales
{
    ...
    public static class RefundHelper
    {
        ...
        public static DataTable GetOrderReturnsBySwr(string swr)
        {
            return new RefundDao().GetOrderReturnsBySwr(swr);
        }
        public static DataTable GetOrderReturnsByOrderid(string orderid)
        {
            return new RefundDao().GetOrderReturnsByOrderid(orderid);
        }
    }
}
