namespace Hidistro.ControlPanel.Function
{
    ...
    public sealed class DataBaseHelper
    {
        ...
        public static DataTable GetDataTable(string tableName, string where="", string order="")
        {
         ...
         public static DataTable GetMemberDataTable(string sql, string where="", string order="")
        {
            return new CommonDao().GetMemberDataTable(sql, where, order);
        }
        ...
        public static DataTable GetMembersAttributeByWhere(string strTableName,string where)
        {
            return new CommonDao().GetDataTable(strTableName, where, "");
        }
