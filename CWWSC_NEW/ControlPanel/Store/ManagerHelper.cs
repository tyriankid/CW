namespace Hidistro.ControlPanel.Store
{
    ...
    public static class ManagerHelper
    {
        ...
        public static DataTable GetManagersbyClientUserId(ManagerQuery query)
        {
            return new MessageDao().GetManagersbyClientUserId(query);
        }
        ...
        /// <returns></returns>
        public static bool ExistClientUserId(int roleid,int userId)
        {
            return new MessageDao().ExistClientUserId(roleid, userId);
        }
        ...
        public static bool DeleteManagerBywhere(int roleid,int clientuserid)
        {
            return new MessageDao().DeleteManagerByRoleIdandClientUserId(roleid, clientuserid);
        }
    }
}
