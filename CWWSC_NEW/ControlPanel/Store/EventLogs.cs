namespace Hidistro.ControlPanel.Store
{
    ...
    public static class EventLogs
    {
        ...
        public static void WriteOperationLog(Privilege privilege, string description,bool isCheck = true)
        {
            OperationLogEntry entry = new OperationLogEntry {
                ...
                UserName = isCheck ? ManagerHelper.GetCurrentManager().UserName : "admin"
            };
            new LogDao().WriteOperationLogEntry(entry);
        }

        public static void WriteOperationLogEx(Privilege privilege, string description,string userName)
        {
            OperationLogEntry entry = new OperationLogEntry
            {
                AddedTime = DateTime.Now,
