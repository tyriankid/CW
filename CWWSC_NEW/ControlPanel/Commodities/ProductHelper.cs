namespace Hidistro.ControlPanel.Commodities
{
    ...
    public static class ProductHelper
    {
        ...
        /// <returns></returns>
        public static DataTable GetStoreProductBaseInfo(string where = "")
        {
            return new ProductDao().GetStoreProductBaseInfo(where);
        }
        /// <summary>
        /// 查询当前分公司的当前商品数量 2017-8-2 YK
        /// </summary>
        /// <param name="where"></param>
        /// <returns></returns>
        public static int SelectFilialeProductNum(string ProductCode, int FilialeId)
        {
            return new ProductDao().SelectFilialeProductNum(ProductCode, FilialeId);
        }
        /// <summary>
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        public static DataTable GetFilialeProductDetail(string ProductCode)
        {
            return new ProductDao().GetFilialeProductDetail(ProductCode);
        }
        ...
        public static decimal GetSkuCostPrice(string skuid)
        {
            return new ProductDao().GetSkuCostPrice(skuid);
        }

        public static decimal GetSkuSalePrice(string skuid)
        {
            return new ProductDao().GetSkuSalePrice(skuid);
        }
        ...
        public static DbQueryResult GetProductsAndCode(ProductQuery query)
        {
            return new ProductDao().GetProductsAndCode(query);
        }
        public static ProductQuery GetHishop_ProductsId(int ProductId)
        {
            return new ProductDao().GetHishop_ProductsId(ProductId);
        }
        ...
        /// <returns></returns>
        public static DbQueryResult GetProductsBySku(ProductQuery query)
        {
            return new ProductDao().GetProductsBySku(query);
        }
        ...
        /// <returns></returns>
        public static DbQueryResult GetProductsByAgent(ProductQuery query)
        {
            return new ProductDao().GetProductsByAgent(query);
        }
        ...
        public static List<ProductReviewAndReplyQuery> SelectProduct()
        {
            return new ProductBatchDao().SelectProduct();    
        }
        ...
        /// <summary>
        /// 分公司(总部)还原线下商品 2017-8-8 yk
        /// </summary>
        /// <param name="productIds"></param>
        /// <returns></returns>
        public static int UpLineProduct(string productIds,ProductSaleStatus status)
        {
            if (string.IsNullOrEmpty(productIds))
            {
                return 0;
            }
            int num = new ProductDao().UpdateProductSaleStatus(productIds, status);
            if (num > 0)
            {
                EventLogs.WriteOperationLog(Privilege.UpShelfProducts, string.Format(CultureInfo.InvariantCulture, "批量还原了 “{0}” 件商品", new object[] { num }));
            }
            return num;
        }
        /// <summary>
        /// 供应商还原商品，还原后商品为已待审核状态
        /// </summary>
        /// <param name="productIds"></param>
        /// <returns></returns>
        public static int UpSupplierShelf(string productIds)
        {
            ManagerHelper.CheckPrivilege(Privilege.UpShelfProducts);
            if (string.IsNullOrEmpty(productIds))
            {
            ...
            int num = new ProductDao().UpdateProductSaleStatus(productIds, ProductSaleStatus.OnAuditing);
            if (num > 0)
            {
                EventLogs.WriteOperationLog(Privilege.UpShelfProducts, string.Format(CultureInfo.InvariantCulture, "供应商批量还原了 “{0}” 件商品，等待管理员审核。", new object[] { num }));
            }
            return num;
        }
        ...
        public static bool UpdateProductSaleStatus(string productIds, int status)
        {
            return new ProductBatchDao().UpdateProductSaleStatus(productIds, status);
        }
        ...
        /// <param name="status">状态</param>
        /// <returns>true成功，false失败</returns>
        public static bool UpdateProductSaleStatus(string productIds, int status, string productcode)
        {
            return new ProductBatchDao().UpdateProductSaleStatus(productIds, status, productcode);
        }
        ...
        /// <returns></returns>
        public static bool InsertPFPrices(List<ProductPfPriceInfo> infolist)
        {
            return new ProductBatchDao().InsertPFPrices(infolist);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static bool DeltePFPrices(int productId)
        {
            return new ProductBatchDao().DeltePFPrices(productId);
        }
        ...
        /// <param name="productIds"></param>
        /// <returns></returns>
        public static DataTable GetProductPfPrices(int productId)
        {
            return new ProductBatchDao().GetProductPfPrices(productId);
        }
        ...
        /// <returns>数据集</returns>
        public static DataTable GetProductSkuItem(int productid)
        {
            return new ProductDao().GetProductSkuItem(productid);
        }
