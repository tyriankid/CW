namespace Hidistro.ControlPanel.Config
{
    ...
    public class CustomConfigHelper
    {
        ...
        private string distributorType_ShowfootService = "服务订单";
        public string DistributorType_ShowfootService
        {
            get { return distributorType_ShowfootService; }
        }

        private string distributorType_Showfootapply = "认证开店";
        ...
        {
            string strHeaders = "原始订单编号,商品编号,商品数量,成本价,商品单价,商品描述,订单产生时间,付款时间,发货时间,收货时间,收货人姓名,收货人手机,备注,物流公司,物流单号,送货地区,详细地址";
            return (strHeaders);
        }
        ...
        public string IsMemberExcel()
        {
            string strHeaders = "会员昵称,会员姓名,邮箱,电话,QQ,详细地址";
            return (strHeaders);
        }
        ...
        /// O2O会员信息导入列名称
        /// </summary>
        /// <returns>列明字符串集合以“,”分隔</returns>
        public string O2OMemberInPortExcel()
        {
            return "会员名称,性别,会员电话,职业,门店DZ号,门店名称,会员等级,会员生日,购买产品型号,购买日期,产品类型,产品价格,所属地区,详细地址,家庭成员构成,用户住房信息,房屋家电配置,家电使用情况,个人品牌倾向,近期购买需求,备注";
        }
    }
}
