    ...
    public class SkuDao
    {
        ...
        public SKUItem GetProductAndSku(MemberInfo currentMember, int productId, string options,bool isMemberPrice = true)//是否需要计算会员价
        {
            ...
            if (currentMember != null)
            {
                ...
                builder.Append("SELECT SkuId, ProductId, SKU,Weight, Stock, CostPrice,NeigouPrice,");
            ...
            {
                builder.Append("SELECT SkuId, ProductId, SKU,Weight, Stock, CostPrice, NeigouPrice, SalePrice FROM Hishop_SKUs WHERE ProductId = @ProductId");
            }
