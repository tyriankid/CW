...
<a href="<%# Globals.ApplicationPath +(Eval("ProductSource").ToString()=="3"?"/Vshop/ProductServiceDetails.aspx?ProductId=":"/Vshop/ProductDetails.aspx?ProductId=") + Eval("ProductId") %>" class="detailLink">
    <div class="box">
        <div class="left">
