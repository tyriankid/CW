   ...
   <!--商品循环区end-->
    ...
    <!-- 订单信息区(下方)-->
            <div class="link-box" >
                ...
                <span><a href='<%# Globals.ApplicationPath + "/Vshop/MyLogistics.aspx?OrderId=" + Eval("OrderId") %> ' class='link <%# ((int)Eval("OrderStatus") == 3 || (int)Eval("OrderStatus") == 5) ? "link" : "hide"%>'>查看物流</a></span>
            </div>
