<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportFile.aspx.cs"      MasterPageFile="~/Admin/Admin.Master"  Inherits="Admin_store_ImportFile" %>
        ...
        <asp:Repeater ID="repeateExcel" runat="server">
            ...
            <table width="0" border="0" cellspacing="0">
                <tr class="table_title">
                    ...
                    <td style="width:2%;" class="td_right">供应商名称
                    </td>
                    <td style="width:4%;" class="td_right">供应商电话
                    </td>
                    <td style="width:4%;" class="td_right">供应商地址
                    </td>
                    <td style="width:3%;" class="td_right">供应商排序
                    </td>
            ...
            <tr class="td_bg noboer_tr">
                ...
                <td class="td_txt_cenetr" style='background-color: <%#Eval("errorInfo").ToString().Count()>0?"#FB6363":" "%>;'>
                    <span><%#Eval("供应商名称") %></span>

                </td>
                <td class="td_txt_cenetr" style='background-color: <%#Eval("errorInfo").ToString().Count()>0?"#FB6363":" "%>;'>
                    <span><%#Eval("供应商电话") %></span>

                </td>
                <td class="td_txt_cenetr" style='background-color: <%#Eval("errorInfo").ToString().Count()>0?"#FB6363":" "%>;'>
                    <span><%#Eval("供应商地址") %></span>

                </td>
                <td class="td_txt_cenetr" style='background-color: <%#Eval("errorInfo").ToString().Count()>0?"#FB6363":" "%>;'>
                    <span><%#Eval("供应商排序") %></span>
