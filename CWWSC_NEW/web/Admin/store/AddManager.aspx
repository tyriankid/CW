          ...
          <asp:Panel ID="PanelID" runat="server">
                ...
                <ul>
                  <li> <span class="formitemtitle Pw_110"><em >*</em>用户名：</span>
                    ...
                    <p id="ctl00_contentHolder_txtUserNameTip">用户名不能为空，必须以汉字或是字母开头,且在3-20个字符之间,请输入员工工号</p>
                  </li>
                  ...
                  <li><span class="formitemtitle Pw_110">后台昵称：</span><%--<em >*</em>--%>
                    <asp:TextBox ID="txtAgentName" runat="server" MaxLength="20" CssClass="forminput" />            
                    <%--<p id="ctl00_contentHolder_txtAgentNameTip">用户名不能为空，必须以汉字或是字母开头,且在3-20个字符之间</p>--%>
...
<script type="text/javascript" language="javascript">
    function InitValidators() {
        ...
        initValid(new InputValidator('ctl00_contentHolder_txtEmail', 0, 256, true, '[\\w-]+(\\.[\\w-]+)*@[\\w-]+(\.[\\w-]+)+', '请输入有效的电子邮件地址，电子邮件地址的长度在256个字符以内'))
        initValid(new SelectValidator('ctl00_contentHolder_dropRole', false, '选择管理员要加入的部门'))
        //initValid(new InputValidator('ctl00_contentHolder_txtAgentName', 3, 20, false, '[\u4e00-\u9fa5a-zA-Z]+[\u4e00-\u9fa5_a-zA-Z0-9]*', '用户名不能为空，必须以汉字或是字母开头,且在3-20个字符之间'))
    }
