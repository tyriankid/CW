    ...
    <UI:Grid ID="grdManager" runat="server" AutoGenerateColumns="False"  ShowHeader="true" DataKeyNames="UserId" GridLines="None"
                   HeaderStyle-CssClass="table_title"  SortOrderBy="CreateDate" SortOrder="ASC" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="用户名" SortExpression="UserName" ItemStyle-Width="150px" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate>
	                                <asp:Label ID="lblUserName" runat="server" Text='<%# Bind("UserName") %>'></asp:Label>      
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="后台昵称" SortExpression="AgentName" ItemStyle-Width="280px" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate>
	                                <asp:Label ID="lblAgentName" runat="server" Text='<%# Bind("AgentName") %>'></asp:Label>      
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="用户部门" SortExpression="RoleId" ItemStyle-Width="120px" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate>
	                                <asp:Literal ID="lblRoleName" runat="server" Text='<%# Bind("RoleId") %>'></asp:Literal>      
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="创建时间" SortExpression="CreateDate" HeaderStyle-CssClass="td_right td_left">
                         ...
                         <ItemStyle CssClass="spanD spanN" />
                             <ItemTemplate>
                                 ...
                                 <span class="submit_tiajia" style="display:<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.RegionalFunction?"":"none" %>"  ><a href='<%# Globals.GetAdminAbsolutePath("/store/RoleAreaPermissions.aspx?UserId=" + Eval("UserId"))%> ' >所属区域</a></span>
