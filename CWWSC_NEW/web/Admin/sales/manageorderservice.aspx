<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="manageorderservice.aspx.cs" Inherits="Hidistro.UI.Web.Admin.manageorderservice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="optiongroup mainwidth">
        <ul>
            ...
            <li id="anchorsBuyerAlreadyPaid">
                <asp:HyperLink ID="hlinkYetPay" runat="server" Text=""><span>等待配单</span></asp:HyperLink></li>
            <li id="anchorsSellerAlreadySent">
                <asp:HyperLink ID="hlinkSendGoods" runat="server" Text=""><span>已配单</span></asp:HyperLink></li>
    ...
    <div class="dataarea mainwidth">
        ...
        <div class="searcharea clearfix br_search search_titxt">
            <ul>
                ...
                <li>
                    <span>服务门店金力账号：</span>
                    <span><asp:TextBox ID="txtAllHereCode" runat="server" CssClass="forminput" /></span>
                </li>
            ...
            <div class="batchHandleArea">
                <ul>
                    ...
                    <li class="batchHandleButton" style="width:100%;margin-top:10px; display:none;">
                        <span class="sendproducts" ><asp:Button  runat="server"  id="btnPack" onclientclick="return pack()"  Text="订单导出" style="display: block;background: transparent;line-height: 22px;border: none;outline: none;color: #fff;"></asp:Button></span> 
                        <span style="position:relative;line-height:22px;overflow:hidden;"><asp:FileUpload ID="fileOrderInfoPack" runat="server" style="position: absolute;left: 0;top: 0;opacity: 0;filter:alpha(opacity=0);-webkit-opacity: 0;z-index: 1;"/>点击这里上传文件</span>
                        <span class="sendproducts"><asp:Button  runat="server"  id="btnUnPack" Text="订单导入"  style="display: block;background: transparent;line-height: 22px;border: none;outline: none;color: #fff;"></asp:Button></span>
                        <span class="sendproducts" style="display:<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.IsJiuZhouTong?"none":"" %>"><asp:Button  runat="server"  id="btnMail" Text="打印电子面单"   OnClientClick="return Mail()" style="display: block;background: transparent;line-height: 22px;border: none;outline: none;color: #fff;"></asp:Button></span>
            ...
            <asp:DataList ID="dlstOrders" runat="server" DataKeyField="OrderId" Width="100%">
                ...
                <ItemTemplate>
                    <tr class="td_bg noboer_tr">
                        ...
                        <td style="color:#666;">
                            <%# "订单服务门店：<a href=\"javascript:ShowOrderSourceService('"+Eval("OrderId")+"');\">" + Eval("serviceStoreName") + "</a>"%>
                        </td>
                    ...
                    <tr class="td_bg">
                        ...
                        <td style="font-weight: bold; font-family: Arial;">
                            <%--金力同步：<%#Eval("submitgk").ToString() == "1" ? "已同步" : "未同步" %>
                            <%# string.IsNullOrEmpty(Eval("KukaiCode").ToString()) ? "" : Eval("submitkk").ToString() == "1" ? "&nbsp;/&nbsp;酷开同步：已同步" : "&nbsp;/&nbsp;酷开同步：未同步" %><br />--%>
                            <Hi:FormatedMoneyLabel ID="lblOrderTotal" CssClass="money" Money='<%#Eval("OrderTotal") %>' runat="server" />
                            <%--修改价格--%> 
                            <%--<span class="Name">
                                <asp:HyperLink ID="lkbtnEditPrice" CssClass="edit_bi" runat="server" NavigateUrl='<%# "EditOrder.aspx?OrderId="+ Eval("OrderId") %>'   Text="修改" Visible="false"> </asp:HyperLink>
                            </span>--%>
                        </td>
                        <td style="color: #000" class="td_txt_right">
                            <Hi:OrderStatusLabelService ID="lblOrderStatus" OrderStatusCode='<%# Eval("OrderStatus") %>'
                                runat="server" />
    ...
    <div id="showOrderSourceService" style="display: none;">
        <div class="frame-content">
            <p>
                <em>溯源详情</em></p>
            <p>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowOrderSourceService(orderId) {
            $("#fgsName").html("");
            $("#fgsCell").html("");
            $("#storeDzCode").html("");
            $("#storeName").html("");
            ...
            $.ajax({
                type: "get",
                url: url,
                data: { action: 'showordersourceservice', orderId: orderId },
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data.success == "true") {
                        ...
                        DialogShow("订单来源", 'sourceframe', 'showOrderSourceService');
                    } else
