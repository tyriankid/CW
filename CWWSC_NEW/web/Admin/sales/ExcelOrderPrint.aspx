    ...
    <asp:Repeater ID="repeateExcel" runat="server">
        <HeaderTemplate>
            <table width="0" border="0" cellspacing="0">
                <tr class="table_title">
                    ...
                    <td style="width:5%;" class="td_right">物流单号
                    </td>
        ...
        <ItemTemplate>
            <tr class="td_bg noboer_tr">
                ...
                <td style='background-color: <%#Eval("errorInfo").ToString().Count()>0?"#e1d7d7":" "%>;' class="td_txt_cenetr">
                    <span style="<%#Eval("errorFields").ToString().IndexOf("物流单号")>-1?"color:red": "" %>"><%#Eval("物流单号") %></span>
                </td>
                ...
                <td style='background-color: <%#Eval("errorInfo").ToString().Count()>0?"#e1d7d7":" "%>;' class="td_txt_cenetr">
                    <span><%# Eval("errorInfo").ToString().Length>30?Eval("errorInfo").ToString().Substring(0,15)+"...":Eval("errorInfo").ToString()%></span>
                </td>
            </tr>
        </ItemTemplate>
