<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="manageordergift.aspx.cs" Inherits="Hidistro.UI.Web.Admin.manageordergift" %>
                ...
                <ItemTemplate>
                    ...
                    <tr class="td_bg">
                        ...
                        <td style="font-weight: bold; font-family: Arial;">
                            <br />
                            <%--<Hi:FormatedMoneyLabel ID="lblOrderTotal" CssClass="money" Money='<%#Eval("costPoint") %>' runat="server" />--%>
                            <span style="color:#f60"><%#Eval("costPoint") %></span>&nbsp;&nbsp;积分
                            <span class="Name">
                               <%--修改价格--%> 
                        ...
                        <td class="td_txt_cenetr">
                           &nbsp;<span class="Name" style="text-indent:0px;">
                                ...
                                <asp:Label CssClass="submit_faihuo" ID="lkbtnSendGoods" Visible="false" runat="server" > 
                                    ...
                                    <%# Eval("OrderStatus").ToString() == "2" ? "<a href=\"javascript:DialogFrame('sales/SendOrderGoods.aspx?OrderId="+Eval("OrderId")+"&reurl=encodeURIComponent(goUrl)','订单发货',null,null, function () { location.href=goUrl })\">发货</a>" : "" %>
                                </asp:Label>
                                <br />
