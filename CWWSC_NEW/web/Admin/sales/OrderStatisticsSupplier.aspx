<%@ Page Language="C#" AutoEventWireup="true" Inherits="Hidistro.UI.Web.Admin.OrderStatisticsSupplier" MasterPageFile="~/Admin/Admin.Master" %>
...
<!--选项卡-->
  ...
  <span>查询有购买记录客户的订单统计，您可以按时间查询客户的总订单数和总订单金额。</span>
      ...
      <div class="searcharea clearfix ">
            ...
            <li><span>门店DZ号：</span>
                <span>
                    <asp:TextBox ID="txtAllHereCode" runat="server" CssClass="forminput"></asp:TextBox>
                </span>
            </li>
            <li><span>门店名称：</span>
                <span>
	  ...
	  <table cellspacing="0" border="0" id="TabOrders" style="width:100%;border-collapse:collapse;">
		<tr class="table_title">
            ...
            <th class="td_right td_left" scope="col">门店DZ号</th>
            <th class="td_right td_left" scope="col">门店名称</th>
            <th class="td_right td_left" scope="col">下单时间</th>
            <th class="td_right td_left" scope="col">总订单金额</th>
            <th class="td_right td_left" scope="col">昵称</th>
            <th class="td_right td_left" scope="col">收货人</th>
            <th role="profit" class="td_left td_right_fff" scope="col">佣金</th>
		</tr>
    ...
    <ItemTemplate>
	   <tr style="cursor:pointer;" title="点击查看商品列表">
           ...
           <td class="td_txt_cenetr"><%# Eval("accountALLHere")%></td>
           <td class="td_txt_cenetr"><%# Eval("storeName")%></td>
           ...
           <td class="td_txt_right">
               <Hi:FormatedMoneyLabel role="profit" ID="FormatedMoneyLabelForAdmin2" Money='<%#Eval("CommTotal") %>' runat="server" ></Hi:FormatedMoneyLabel>
