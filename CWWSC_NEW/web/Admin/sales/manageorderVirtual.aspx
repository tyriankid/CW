<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="manageorderVirtual.aspx.cs" Inherits="Hidistro.UI.Web.Admin.manageorderVirtual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="optiongroup mainwidth">
        <ul>
            ...
            <li id="anchorsBuyerAlreadyPaid" style="display:none">
                <asp:HyperLink ID="hlinkYetPay" runat="server" Text=""><span>等待发货</span></asp:HyperLink></li>
            <li id="anchorsSellerAlreadySent" style="display:none">
            ...
            <asp:DataList ID="dlstOrders" runat="server" DataKeyField="OrderId" Width="100%">
                ...
                <ItemTemplate>
                    <tr class="td_bg noboer_tr">
                        ...
                        <td><!--配送信息-->
                            <%--配送门店：<%#Eval("ModeName") %>--%>
                            <asp:Literal runat="server" ID="litVirtualCode" Text="" />
                        </td>
                    ...
                    <tr class="td_bg">
                        <td>
                            ...
                            &nbsp;姓名：<%#Eval("RealName") %></td>
                        <td>
                            <%--收件人：<%#Eval("ShipTo") %>&nbsp;&nbsp;电话：<%#Eval("CellPhone") %>--%>
                        </td>
                        <td><!--配送信息-->
                            <%--地址：<%#Eval("Address") %>--%>
                        </td>
                        ...
                        <td class="td_txt_cenetr">
                           &nbsp;<span class="Name" style="text-indent:0px;">
                                ...
                                <br />
                                <a class="link_default_gray" name="link_default_gray" href="javascript:SendAH('<%#Eval("OrderId") %>');"><%#(Eval("OrderStatus").ToString() == "5" && Eval("submitgk").ToString() == "0") ? "推送金力" : "" %></a>
                               <a class="link_default_gray" name="link_default_gray" href="javascript:SendKK('<%#Eval("OrderId") %>');"><%#(Eval("OrderStatus").ToString() == "5" && Eval("submitgk").ToString() == "1" && Eval("submitkk").ToString() == "0" && !string.IsNullOrEmpty(Eval("KukaiCode").ToString())) ? "推送酷开" : "" %></a>
