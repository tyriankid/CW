...
<div class="dataarea mainwidth databody">
      ...
      <div class="datafrom">
          <div class="formitem validator1">
           <ul>
            ...
            <li><span class="formitemtitle Pw_198"><em >*</em>收货后几天内可以申请退货：</span>
              <asp:TextBox ID="txtTakeGoodsDays" runat="server" CssClass="forminput" />
              <p id="txtTakeGoodsDaysTip" runat="server">用户确认收货后几天，系统允许用户发起退货申请，如果设置的天数小于发货自动关闭订单的天数，订单自动完成后将无法再发起退货申请，所以订单自动完成时间最好大于 > (本配置天数+物流天数）。</p>
            </li>      
    ...
    <script>
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtTakeGoodsDays', 1, 10, false, '-?[0-9]\\d*', '发货几天后，系统自动把订单改成已完成状态'))
            appendValid(new NumberRangeValidator('ctl00_contentHolder_txtTakeGoodsDays', 0, 90, '发货几天后，系统自动把订单改成已完成状态'));
