...
<asp:Content ID="Content1" ContentPlaceHolderID="headHolder" runat="server">
    <script src="order.helper.js?time=20151027" type="text/javascript"></script>
      <script type="text/javascript">
          ...
          function WxRefund(orderid, refundmoney) {
              if (confirm("确认要重新推送吗？")) {
                  var url = '/API/VshopProcess.ashx';
                  $.ajax({
                      type: "get",
                      url: url,
                      data: { action: 'wxrefund', orderId: orderId, refundMoney: refundmoney },
                      dataType: "json",
                      async: false,
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)"  style='<%# Eval("HandleStatus").ToString()=="2" ? "" : "display:none" %>'
                                     id="lkbtnWxrefund" onclick="WxRefund('<%# Eval("OrderId") %>','<%# Eval("RefundMoney","{0:F2}") %>')">商户号退款</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
