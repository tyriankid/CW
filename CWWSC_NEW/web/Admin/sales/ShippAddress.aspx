...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
 ...
 <div id="dlgShipTo">
    <div class="frame-content">
        ...
        <p><span class="frame-span frame-input90">发票塔头：<em>*</em></span><asp:TextBox ID="txtTelPhone" runat="server" CssClass="forminput"></asp:TextBox></p>
        <p><span class="frame-span frame-input90">手机号码：<em>*</em></span><asp:TextBox ID="txtCellPhone" runat="server" CssClass="forminput"></asp:TextBox></p>
    </div>
...
<script>
    function ValidationAddress() {
        ...
        if (shipTo.length < 2 || shipTo.length > 6) {
            alert("收货人名字不能为空，长度在2-6个字符之间");
            return false;
        }
        ...
        if (telPhone.length == 0 || telPhone.length > 20) {
            //return true;
            alert("发票抬头不能为空，长度不大于20个字符之间");
            return false;
        }
        //else {
        ...
        if (cellPhone.length == 0 || cellPhone.length > 20) {
            alert("手机号码不能为空，长度不大于20个字符之间");
            return false;
        }
        //else {
