...
<div class="dataarea mainwidth databody">
    <div class="title"> <em><img src="../images/05.gif" width="32" height="32" /></em>
     ...
     <div class="searcharea clearfix">
        <ul>
            <li>实际配送方式： <hi:ShippingModeDropDownList runat="server" AllowNull="true" ID="dropShippingMode" /></li>
			...
			<li style="margin-left:10px;">起始发货单号</li><li><asp:TextBox ID="txtStartShipOrderNumber" ClientIDMode="Static" CssClass="forminput" runat="server" /></li>
    ...
    <div class="datalist">
     <UI:Grid ID="grdOrderGoods" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="OrderId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
            <Columns>
                ...
                <UI:DropdownColumn HeaderText="用户配送方式" ItemStyle-Width="100px" 
                      JustForEditItem="false" ID="dropShippId" DataKey="ShippingModeId" DataTextField="Name"
                      DataValueField="ModeId" AllowNull="false" >
                </UI:DropdownColumn>
                <UI:DropdownColumn HeaderText="实际配送方式" ItemStyle-Width="100px" 
                      JustForEditItem="false" ID="dropRealShippId" DataKey="RealShippingModeId" DataTextField="Name"
                      DataValueField="ModeId" AllowNull="false" >
                </UI:DropdownColumn>
