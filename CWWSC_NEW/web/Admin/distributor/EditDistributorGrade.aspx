...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator4 clearfix">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_110">需要<%=Hidistro.Core.SettingsManager.GetMasterSettings(false).DistributorUpgradeType=="byComm"?"佣金":"销售额" %>达到</span><asp:TextBox ID="txtCommissionsLimit" runat="server" CssClass="forminput"></asp:TextBox><span style="padding-left:5px">元</span> <span style="color:#ccc; padding-left:5px;"><%=Hidistro.Core.SettingsManager.GetMasterSettings(false).DistributorUpgradeType=="byComm"?"(算三级内的佣金)":"" %></span>
          <p id="ctl00_contentHolder_txtCommissionsLimitTip"></p>
          </li>         
          ...
          <%--<li> <span class="formitemtitle Pw_110">二级抽佣比上浮</span><asp:TextBox ID="txtSecondCommissionRise" runat="server" CssClass="forminput"></asp:TextBox>%<p id="ctl00_contentHolder_txtSecondCommissionRiseTip"></p>
          </li>
          <li> <span class="formitemtitle Pw_110">三级抽佣比上浮</span><asp:TextBox ID="txtThirdCommissionRise" runat="server" CssClass="forminput"></asp:TextBox>%<p id="ctl00_contentHolder_txtThirdCommissionRiseTip"></p>
          </li>--%>
          ...
          <li style="margin-bottom:10px;"> <span class="formitemtitle Pw_110">设成默认：</span><asp:RadioButtonList ID="rbtnlIsDefault" runat="server" RepeatDirection="Horizontal">
