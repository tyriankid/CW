...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title">
            ...
            <asp:Button ID="btnSendAllRedPack" runat="server" Text="发送全部微信红包" CssClass="submit_queding" OnClientClick="return confirm('确认要发送当前所有未发送的微信红包吗？')" OnClick="btnSendAllRedPack_Click" />
        </div>
        <!--搜索-->
        <!--数据列表区域-->
        <div class="datalist">
            <table>
                ...
                <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand" OnItemDataBound="rptList_ItemDataBound">
                    <ItemTemplate>
                        <tbody>
                            <tr>
                                <td>&nbsp;￥<%#(decimal.Parse(Eval("Amount").ToString())/100).ToString("0.00")%></td>
