            ...
            onitemcommand="rpMaterial_ItemCommand" >
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("StartTime","{0:yyyy-MM-dd HH:00}")%></td>
                            <td>
                             <%#Eval("EndTime","{0:yyyy-MM-dd HH:00}")%>
                            </td>
                          <td><span class="submit_bianji" style="width: 23px; float: left; padding-top: 6px;line-height: 23px;height: 23px;padding-right:2px;"><span id="spcopy<%#Container.ItemIndex+1 %>" title="复制"></span></span>
                              ...
                              <%--<span class="submit_bianji"><asp:LinkButton ID="Lkbtndel" CommandName="del" CommandArgument='<%#Eval("ActivityID")%>' runat="server" DeleteMsg="确定要删除吗？">删除</asp:LinkButton></span>--%>
                              <span class="submit_bianji"><Hi:ImageLinkButton ID="ImageLinkButton1" runat="server" IsShow="true" Text="删除" CommandArgument='<%# Eval("ActivityID")%>' CommandName="del" DeleteMsg="确定要删除吗？" /></span>
