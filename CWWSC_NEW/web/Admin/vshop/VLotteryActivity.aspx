            ...
            <div class="formitem validator2">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_100">一等奖描述：<em>*</em></span>
                        ...
                        <span style="float:left">&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize1Num" runat="server" CssClass="forminput"></asp:TextBox>
                        <span style="float:left">&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability1" runat="server" CssClass="forminput"></asp:TextBox>
                        %<p id="txtPrize1Tip">
                            一等奖描述不能为空</p>
                    ...
                    <li><span class="formitemtitle Pw_100">二等奖描述：<em>*</em></span>
                        ...
                        <span style="float:left">&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize2Num" runat="server" CssClass="forminput"></asp:TextBox>
                         <span style="float:left">&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability2" runat="server" CssClass="forminput"></asp:TextBox>
                        %<p id="txtPrize2Tip">
                            二等奖描述不能为空</p>
                        </li>
                    <li><span class="formitemtitle Pw_100">三等奖描述：<em>*</em></span>
                        <asp:TextBox ID="txtPrize3" runat="server" CssClass="forminput"></asp:TextBox>
                        <span style="float:left">&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize3Num" runat="server" CssClass="forminput"></asp:TextBox>
                         <span style="float:left">&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability3" runat="server" CssClass="forminput"></asp:TextBox>
                    ...
                    <li class="hiddenli"><span class="formitemtitle Pw_100">四等奖描述：</span>
                        ...
                        <span style="float:left">&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize4Num" runat="server" CssClass="forminput"></asp:TextBox>
                        <span style="float:left">&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability4" runat="server" CssClass="forminput"></asp:TextBox>%
                    ...
                    <li class="hiddenli"><span class="formitemtitle Pw_100">五等奖描述：</span>
                        ...
                        <span style="float:left">&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize5Num" runat="server" CssClass="forminput"></asp:TextBox>
                        <span style="float:left">&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability5" runat="server" CssClass="forminput"></asp:TextBox>%
                        <span class="hiddenjf" style="display:none">
                    ...
                    <li class="hiddenli">
                        <span  class="formitemtitle Pw_100">六等奖积分：</span><asp:TextBox ID="txtPrize6" runat="server" CssClass="forminput"></asp:TextBox>
                        <span style="float:left">&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize6Num" runat="server" CssClass="forminput"></asp:TextBox>
                         <span style="float:left">&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability6" runat="server" CssClass="forminput"></asp:TextBox>%
                        <span class="hiddenjf" style="display:none">
