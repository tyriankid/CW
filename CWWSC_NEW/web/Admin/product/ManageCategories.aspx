...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        ...
        <div class="datalist">
                    ...
                    <img src="../images/jia.gif" width="24" height="24" /></span> <span style="padding-bottom: 5px;display:none">
                        <a id="openAll" style="cursor: pointer; position: relative; top: -6px;">全部展开</a></span> <span style="display:none">
                            <img src="../images/jian.gif" width="24" height="24" /></span> <span style="display:none"><a id="closeAll"
                                style="cursor: pointer; position: relative; top: -6px;">全部收缩</a></span> <span>
            ...
            <UI:Grid ID="grdTopCategries" DataKeyNames="CategoryId" runat="server" ShowHeader="true"
                ...
                Width="100%">
                <Columns>
                    <asp:TemplateField HeaderText="ID" HeaderStyle-Width="80px" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <%# Eval("CategoryId") %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="分类名称" HeaderStyle-Width="30%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                        ...
                        <ItemTemplate>
                            ...
                            <span class="submit_shanchu">
                                <Hi:ImageLinkButton runat="server" IsShow="true" Text="删除" CommandName="DeleteCagetory"
                                    DeleteMsg="删除分类会级联删除其所有子分类，确定要删除选择的分类吗？" />
                            </span> 
                            <span class="Name icon Pg_10">
                                <%--<a href="javascript:void(0)" onclick="EditeCommission(<%# Eval("CategoryId")%>,'<%# Eval("FirstCommission") %>','<%# Eval("SecondCommission") %>','<%# Eval("ThirdCommission") %>')">类目佣金</a>--%>
                                        <asp:Literal ID="litlink" runat="server"></asp:Literal>
                            </span>
                            <span class="Name icon Pg_10" style='display:<%=Hidistro.ControlPanel.Config.CustomConfigHelper.Instance.IsQipinhui?"":"none"%>'>
                                <a href="javascript:void(0)" onclick="EditSpecialRate(<%# Eval("CategoryId")%>)">出货折扣设置</a>
                            </span>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
    ...
    <script type="text/javascript">
        ...
        function EditSpecialRate(categroyId) {
            DialogFrame("product/EditSpecialRate.aspx?categroyId=" + categroyId, "设置出货折扣", 880, null);
        }
    </script>
</asp:Content>
