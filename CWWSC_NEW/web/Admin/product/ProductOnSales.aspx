        ...
        <div class="datalist">
            ...
            <div class="searcharea clearfix" style="padding: 3px 0px 10px 0px;">
                <ul>
                    ...
                    <li><a href="ImportFromProducts.aspx">导入商品</a></li>
                </ul>
            </div>
            </div>
            <!--结束-->
            ...
            <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true"
                ...
                <Columns>
                        ...
                        <ItemTemplate>
                            ...
                            <div style="float: left;">
                                <span class="Name"><a href='<%#"../../Vshop/ProductDetails.aspx?isbackshow=1&productId="+Eval("ProductId")%>'
                                    target="_blank">
                                    <%# Eval("ProductName") %></a></span> <span class="colorC" style="display:block">商品内码：<%# Eval("ProductCode") %>库存：<%# Eval("Stock") %>成本价：<%# Eval("CostPrice", "{0:f2}")%></span></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="95" ItemStyle-CssClass="td_txt_cenetr" >
                        <ItemTemplate>
                            <span class="submit_bianji"><a href="javascript:getImages('<%# Eval("ProductId") %>','<%# Eval("ProductCode") %>')">下载二维码</a></span>
                            <%--<span class="submit_bianji" ><Hi:ImageLinkButton runat="server" id="ImageLinkButton1" text="下载推广码" CommandName="Down" CommandArgument='<%# Eval("ProductId") %>'></Hi:ImageLinkButton></span>--%>
