   ...
   <div class="searcharea clearfix ">
	  ...
	  <UI:Grid ID="grdProductSaleStatistics" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                             ...
                             <asp:TemplateField HeaderText="排行" HeaderStyle-CssClass="border_right border_top border_bottom" ItemStyle-CssClass="td_txt_cenetr">
                                <ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="商品名称" DataField="ProductName"  />   
                             <asp:TemplateField HeaderText="商品内码"  ItemStyle-CssClass="td_txt_cenetr">
                                <ItemTemplate>
                                    <asp:Label ID="lblBuyCount"  runat="Server" Text='<%# Eval("SKU") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>   
                              <asp:TemplateField HeaderText="销售量"  ItemStyle-CssClass="td_txt_cenetr" >
                                <ItemTemplate>
                                    <asp:Label ID="lblBuyCount"  runat="Server" Text='<%# Eval("ProductSaleCounts") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>  
                               <asp:TemplateField HeaderText="销售额"  ItemStyle-CssClass="td_txt_right">
                                <ItemTemplate>
                                    <Hi:FormatedMoneyLabel ID="FormatedMoneyLabelForAdmin1" Money='<%#Eval("ProductSaleTotals") %>' runat="server" ></Hi:FormatedMoneyLabel>
                                </ItemTemplate>
                            </asp:TemplateField> 
                             <asp:TemplateField HeaderText="佣金"  ItemStyle-CssClass="td_txt_right">
                                <ItemTemplate>
                                    <Hi:FormatedMoneyLabel ID="FormatedMoneyLabelForAdmin2" Money='<%# Eval("CommTotal") %>' runat="server" ></Hi:FormatedMoneyLabel>
                                </ItemTemplate>
                            </asp:TemplateField>   
                    </Columns>
                </UI:Grid>
      ...
      <div class="blank12 clearfix"></div>
    <div class=" VIPbg m_none colorG" style="display:none">此处的利润是指本站会员订单产生的利润。</div>
	  </div>
     </div>
