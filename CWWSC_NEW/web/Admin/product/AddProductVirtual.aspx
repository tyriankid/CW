<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"  CodeBehind="AddProductVirtual.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddProductVirtual" %>
	    ...
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
	        ...
	        <li>
             ...
             <li class=" clearfix"> <span class="formitemtitle Pw_198"><em >*</em>商品来源：</span>
	            <asp:DropDownList ID="DDLProductSource" runat="server">
                    <asp:ListItem Value="1">创维</asp:ListItem>
                    <asp:ListItem Value="2">供应商</asp:ListItem>
                    <asp:ListItem Value="3">服务</asp:ListItem>
                    <asp:ListItem Value="4">线下</asp:ListItem>
                    <asp:ListItem Value="5">虚拟</asp:ListItem>
                </asp:DropDownList>
	        ...
	        <li><span class="formitemtitle Pw_198">商品内码：</span>
                ...
                <p id="ctl00_contentHolder_txtProductCodeTip">长度不能超过20个字符，只有创维商品才允许填写内码，供应商商品内码以AH回传为主</p>
            </li>
            <%--<li id="KuKaiProductCodePriceRow"><span class="formitemtitle Pw_198">酷开商品内码：</span>
                <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtKuKaiProductCode" />
                <p id="ctl00_contentHolder_txtKuKaiProductCodeTip">长度不能超过20个字符，只有酷开商品才允许填写内码，如果不是酷开的商品则忽略此项，此项是验证酷开商品的唯一依据。</p>
            </li>--%>
	        <li><span class="formitemtitle Pw_198"><em >*</em>计量单位：</span>
	        ...
	        <li id="skuCodeRow"><span class="formitemtitle Pw_198"><em >*</em>型号：</span>
                <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtSku" />
                <p id="ctl00_contentHolder_txtSkuTip">限定在30个字符</p>
            </li>
	        <li id="salePriceRow"><span class="formitemtitle Pw_198"><em >*</em>一口价：</span>
              <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtSalePrice" />&nbsp;元<input type="button" onclick="editProductMemberPrice();" value="编辑会员价" style="margin-left:10px; display:none" />
	        ...
	        <li id="costPriceRow"><span class="formitemtitle Pw_198"><em >*</em>成本(结算)价：</span>
            ...
            <%--<li id="rangeRow"><span class="formitemtitle Pw_198">商品显示范围：</span>
                <asp:DropDownList ID="DDLRange" runat="server">
                    <asp:ListItem Value="0">全部</asp:ListItem>
                    <asp:ListItem Value="1">PC端</asp:ListItem>
                    <asp:ListItem Value="2">手机端</asp:ListItem>
                </asp:DropDownList>
            </li>--%>
            <%--start返佣相关--%>
            <li><h2 class="colorE">佣金规则</h2></li>
            <li>
            ...
            <li id="WholesaleTypePriceRow">
			  <span class="formitemtitle Pw_198">批发价返佣类型：</span>
				<asp:RadioButton runat="server" ID="RadioWholesaleA" GroupName="WholesaleType" Checked="true" Text="比例"></asp:RadioButton>
                <asp:RadioButton runat="server" ID="RadioWholesaleB" GroupName="WholesaleType" Text="金额"></asp:RadioButton>
                <p id="P2">批发价格返佣只适用于供应商商品</p>
 			</li>
            <li id="WholesaleRatioPriceRow"><span class="formitemtitle Pw_198">返佣比例：</span>
                <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtWholesaleCommisionRatio" />&nbsp;%
                <p id="ctl00_contentHolder_txtWholesaleCommisionRatioTip">返佣比例值</p>
            </li>
            <li id="WholesaleMoneyPriceRow"><span class="formitemtitle Pw_198">返佣金额：</span>
                <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtWholesaleCommisionMoney" />&nbsp;元
                <p id="ctl00_contentHolder_txtWholesaleCommisionMoneyTip">返佣金额值</p>
            </li>
            <%--end返佣相关--%>
           ...
           <li class="clearfix"><span class="formitemtitle Pw_198">商品规格：</span>
               ...
               <p style="color:Red;"><asp:CheckBox runat="server" ID="chkPic" Text="是否下载商品描述外站图片" /></p>
                <p class="Pa_198">如果勾选此选项时，商品里面有外站的图片则会下载到本地，相反则不会，由于要下载图片，如果图片过多或图片很大，需要下载的时间就多，请慎重选择。</p>
				<p class="Pa_198">单张图片尺寸建议不要超过：320px * 580px</p>
            </li>
              <%--****--%>
	       <li><h2 class="colorE clear">相关设置</h2></li>
	        <li>
			  <span class="formitemtitle Pw_198">商品销售状态：</span>
                <asp:RadioButton runat="server" ID="radOnAuditing" GroupName="SaleStatus" Text="待审核" Visible="false"></asp:RadioButton>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" src="attributes.virtual.helper.js"></script>
    ...
    <script type="text/javascript" language="javascript">     
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtProductCode', 0, 20, true, null, '商品内码的长度不能超过20个字符'));
            //酷开商品内码
            //initValid(new InputValidator('ctl00_contentHolder_txtKuKaiProductCode', 0, 20, true, null, '酷开商品内码的长度不能超过20个字符'));

            //限购数量
            initValid(new InputValidator('ctl00_contentHolder_txtRestrictNeigouNum', 1, 10, true, '-?[0-9]\\d*', '数据类型错误，只能输入整数型数值'));
            appendValid(new MoneyRangeValidator('ctl00_contentHolder_txtRestrictNeigouNum', 0, 9999999, '输入的数值超出了系统表示范围'));

            initValid(new InputValidator('ctl00_contentHolder_txtUnit', 1, 20, false, '[a-zA-Z\/\u4e00-\u9fa5]*$', '必须限制在20个字符以内且只能是英文和中文例:g/元'));
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtWholesaleCommisionRatio', 1, 6, true, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，只能输入实数型数值'));
            appendValid(new MoneyRangeValidator('ctl00_contentHolder_txtWholesaleCommisionRatio', 0, 100, '输入的数值超出了系统表示范围'));
            
            initValid(new InputValidator('ctl00_contentHolder_txtWholesaleCommisionMoney', 1, 10, true, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，只能输入实数型数值'));
            appendValid(new MoneyRangeValidator('ctl00_contentHolder_txtWholesaleCommisionMoney', 0, 99999999, '输入的数值超出了系统表示范围'));
            /**start返佣值验证***/
