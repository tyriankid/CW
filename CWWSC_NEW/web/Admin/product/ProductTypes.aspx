            ...
            <Columns> 
                    ...
                    <asp:TemplateField HeaderText="备注" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="40%">
                     ...
                     <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_txt_cenetr">
                         ...
                         <ItemTemplate><asp:HyperLink ID="lkbViewAttribute" runat="server" Text="编辑" NavigateUrl='<%# "EditProductType.aspx?TypeId="+Eval("TypeId")%>' ></asp:HyperLink>  <Hi:ImageLinkButton ID="lkbDelete" IsShow="true" runat="server" CommandName="Delete"  Text="删除" />
                         </ItemTemplate>
                     </asp:TemplateField>  
