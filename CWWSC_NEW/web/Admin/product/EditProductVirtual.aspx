<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master" CodeBehind="EditProductVirtual.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditProductVirtual" %>
	    ...
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
	        ...
	        <li id="salePriceRow"><span class="formitemtitle Pw_198">一口价：<em >*</em></span>
              <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtSalePrice" />元<input type="button" style="display:none" class="inp_edit" onclick="editProductMemberPrice();" value="编辑会员价" />
            ...
            <li id="Li1"><span class="formitemtitle Pw_198">返佣比例：</span>
            ...
            <li id="Li2"><span class="formitemtitle Pw_198">返佣金额：</span>
            ...
            <li class="clearfix"><span class="formitemtitle Pw_198">商品描述：</span>
             ...
             <li class="clearfix"><span class="formitemtitle Pw_198">商品规格：</span>
                ...
                <p style="color:Red;"><asp:CheckBox runat="server" ID="chkIsDownPic" Text="是否下载商品描述外站图片" /></p>
                <p class="Pa_198">如果勾选此选项时，商品里面有外站的图片则会下载到本地，相反则不会，由于要下载图片，如果图片过多或图片很大，需要下载的时间就多，请慎重选择。</p>
            </li>
              <%--****--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            ...
            //酷开商品内码
            //initValid(new InputValidator('ctl00_contentHolder_txtKuKaiProductCode', 0, 20, true, null, '酷开商品编码的长度不能超过20个字符'));
