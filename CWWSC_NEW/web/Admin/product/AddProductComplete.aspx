...
<div class="areacolumn clearfix">
      <div class="columnright">
		  ...
		  <div class="Pg_15 Pg_45 fonts">您可以随时到  <span class="Name"><asp:HyperLink ID="hlinkProductList" runat="server" Text="商品列表中" /></span>去编辑商品。</div>
      </div>
        <%--<a href="ProductOnSales.aspx">商品列表中</a>--%>
  </div>
</asp:Content>
