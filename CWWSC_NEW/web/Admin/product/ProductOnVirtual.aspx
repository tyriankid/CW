<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="ProductOnVirtual.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ProductOnVirtual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title">
            ...
            <h1>
                虚拟商品管理</h1>
            <span>店铺中所有的虚拟商品，您可以对商品进行搜索，也能对商品进行编辑、上架、入库等操作</span>
            ...
            <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="95" ItemStyle-CssClass="td_txt_cenetr" >
                        <ItemTemplate>
                            <span class="submit_bianji"><a href="<%#"EditProductVirtual.aspx?productId="+Eval("ProductId")%>&reurl=<%=LocalUrl %>">编辑</a></span>
                            <span class="submit_bianji"><a href="<%#"SetProductVirtualCodes.aspx?productId="+Eval("ProductId")%>&reurl=<%=LocalUrl %>">设置虚拟码</a></span
