<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ProductLineOnDeleted.aspx.cs" Inherits="Hidistro.UI.Web.Admin.ProductLineOnDeleted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	<div class="dataarea mainwidth databody">
     <div class="title">
          ...
          <h1>线下商品回收站</h1>
          <span>线下商品回收站，您可以对回收站中的商品彻底删除，也可以对商品还原到出售中、及仓库中</span>
      </div>
     <div class="datalist">
		<!--搜索-->
			...
			<div class="batchHandleArea">
				<ul>
					<li class="batchHandleButton">
                        ...
                        <span class="downproduct"><asp:LinkButton runat="server" ID="btnUpShelf" Text="还原到商品列表中"  /></span>               
                    </li>
				</ul>
			</div>
		</div>		
