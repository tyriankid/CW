<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"  CodeBehind="AddProductLine.aspx.cs" Inherits="Hidistro.UI.Web.Admin.AddProductLine" %>
	  ...
	  <div class="datafrom">
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
	        ...
	        <li><span class="formitemtitle Pw_198"><em >*</em>商品内码：</span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtProductCode', 0, 20, false, '^[0-9a-zA_Z]+$', '数据类型错误，只能输入字母和数字'));
            //限购数量
