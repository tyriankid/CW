	  ...
	  <div class="datafrom">
	    <div class="formitem validator1">
          ...
          <li><h2 class="colorE">基本信息</h2></li>
            <li class=" clearfix"> <span class="formitemtitle Pw_198">商品来源：</span>
	        ...
	        <li id="costPriceRow"><span class="formitemtitle Pw_198"><em >*</em>结算价：</span>
	            <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtCostPrice" />&nbsp;元
	            <p id="ctl00_contentHolder_txtCostPriceTip">商品的结算价，传入AH供财务结算使用</p>
	        </li>
