<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master" CodeBehind="EditProductService.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditProductService" %>
          ...
          <li><h2 class="colorE">基本信息</h2></li>
            ...
            <li class=" clearfix"> <span class="formitemtitle Pw_198"><em >*</em>商品来源：</span>
             ...
             <li>
                ...
                <p id="P2">系统自动选择，不可修改</p>
	            <%--品牌：<abbr class="formselect"><Hi:BrandCategoriesDropDownList runat="server" ID="dropBrandCategories" NullToDisplay="--请选择--" /></abbr>--%>
            </li>
            <li>
                <span class="formitemtitle Pw_198"><em >*</em>服务品类：</span>
                <abbr class="formselect"><Hi:ProductServiceClassDropDownList  runat="server" ID="dropClassList" NullToDisplay="--请选择--" /></abbr>
                <p id="ctl00_contentHolder_dropClassListTip">请选择服务品类</p>
            </li>
            ...
            <%--<li><span class="formitemtitle Pw_198">酷开商品内码：</span>
            ...
            <li><span class="formitemtitle Pw_198">售出商品显示数量：</span>
	            <Hi:TrimTextBox runat="server" CssClass="forminput" ID="showCounts" />套
	        ...
	        <li id="salePriceRow"><span class="formitemtitle Pw_198">一口价：<em >*</em></span>
              <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtSalePrice" />元
              <%--<input type="button" class="inp_edit" onclick="editProductMemberPrice();" value="编辑会员价" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtProductCode', 1, 20, false, null, '商家编码的长度不能超过20个字符'));
