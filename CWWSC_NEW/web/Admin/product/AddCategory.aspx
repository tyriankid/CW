      ...
      <div class="columnright">
          ...
          <div class="formitem validator2">
            <ul>
              ...
              <li> <span class="formitemtitle Pw_100"><em >*</em>直接佣金：</span>
                ...
                <p id="ctl00_contentHolder_txtfirstTip">（当店铺产生订单后，分销商可获得订单商品总额的比例。）输入0~100的数</p>
              </li>
         <%--     <li><h2 class="colorE">上一级佣金</h2></li>--%>
              <%--<li   > <span class="formitemtitle Pw_100"><em >*</em>上一级佣金：</span>
                ...
                <p id="ctl00_contentHolder_txtsecondTip">（当店铺产生订单后，分销商的上一级可获得订单商品总额的比例。）输入0~100的数</p>
              </li>--%>
            <%--  <li ><h2 class="colorE">上二级佣金</h2></li>--%>
               <%--<li> <span class="formitemtitle Pw_100"><em >*</em>上二级佣金：</span>
                ...
                <p  id="ctl00_contentHolder_txtthirdTip"  >（当店铺产生订单后，分销商的上二级可获得订单商品总额的比例。）输入0~100的数</p>
              </li>--%>
              ...
              <ul class="btn Pa_100 clearfix">
                ...
                <asp:Button ID="btnSaveAddCategory" runat="server" OnClientClick="return PageIsValid();" Text="保存并继续添加" CssClass="submit_DAqueding submit_DAqueding2" />
         </ul>
          </div>
  </div>
