      ...
      <table width="100%" border="0" cellspacing="0" class="goods-list">
        ...
        <ItemTemplate>        
	      ...
	      <td width="32%"><span class="Name">
	        <%# Eval("ItemDescription")%></span> <span class="colorC">型号：<asp:Literal runat="server" ID="litCode" Text='<%#Eval("sku") %>' />
...
<h1>
    <asp:Label ID="lblOrderGifts" runat="server" Text="礼品列表"></asp:Label>
</h1>
    ...
    <HeaderTemplate>
        <table width="200" border="0" cellspacing="0">
            <tr class="table_title">
                ...
                <td width="30" class="td_right td_left">兑换总积分</td>
            </tr>
    </HeaderTemplate>
    <ItemTemplate>
        <tr>
            <td>
                ...
                <span><asp:Literal ID="giftName" runat="server" Text='<%# Eval("GiftName") %>'></asp:Literal></span> </td>
            <td>×<asp:Literal ID="litQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Literal></td>
            <td>
                <span style="color:#f60"><asp:Literal ID="Literal1" runat="server" Text='<%# Eval("costPoint") %>'></asp:Literal></span>
            </td>
        </tr>
    </ItemTemplate>
    <FooterTemplate>
