...
$(function () {
    $(".draw li").each(function () {
        $(this).dblclick(function () {
            ...
            //图片布局框模块--------图片布局框模块--------图片布局框模块
            if ($(this).is(".bjpicture")) {
                bj();
                bjAttr();
            }
            //轮播图模块-----轮播图模块------轮播图模块
...
function integrate(e, j) {
    ...
    $("#addAttr" + j + " input").click(function () {
        ...
        //滚动公告
        if ($(this).attr("name") == "normal" + j + "") {
            switch ($(this).attr("value")) {
                case "normal":
                    $("#gongao").find("a").attr("class","nStyle");
                    break;
                case "blod":
                    $("#gongao").find("a").attr("class", "bStyle");
                    break;
            }
        }
        ...
        if ($(this).attr("name") == "mode" + j + "") {
            switch ($(this).attr("value")) {
                ...
                case "four":
                    ...
                    break;
                case "five":
                    $("#module" + j + " ul").attr("class", "tp_style4");
                    break;
            }
        }
        //图片布局框架
        if ($(this).attr("name") == "bjkj" + j + "") {
            switch ($(this).attr("value")) {
                case "one":
                    $("#module" + j + " ul").attr("class", "bjkj1");
                    break;
                case "two":
                    $("#module" + j + " ul").attr("class", "bjkj2");
                    break;
            }
        }
        ...
        if ($(this).attr("name") == "composition" + j + "") {
            $("#module" + j + " ul #productType").hide();
            $("#module" + j + " ul #productConment").hide();
            switch ($(this).attr("value")) {
                case "manner1":
                ...
                case "manner3":
                    ...
                    $("#module" + j + " ul #productType").show();
                    $("#module" + j + " ul #productConment").show();
                    $("#module" + j + " ul #productImg").addClass("productImg");
...
function dhAttr() {
    var divhtml = "<div id='addAttr" + i + "' class='addAttr' i='" + i + "'>" +
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>" +
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='way" + i + "' value='two' />一行两列</td><td><input type='radio' name='way" + i + "' value='three' />一行三列</td><td><input type='radio' name='way" + i + "' value='four' checked='checked' />一行四列</td><td><input type='radio' name='way" + i + "' value='five' />一行五列</td></tr>" +
...
function addDH(e) {
    ...
    $("#module" + m + " .wb_txt").css("height", $("#addAttr" + m + " .sliding").slider("value") + "px");
...
function ss() {
    var divhtml = "<div id='module" + i + "' i='" + i + "' name='SouSuo' class='small ss'>" +
					"<div class='search_div'><input class='search' type='text' placeholder='商品搜索：请输入商品名称' />" +
...
function ggAttr() {
    var divhtml = "<div id='addAttr" + i + "' class='addAttr' i='" + i + "'>" +
					  "<table class='nav_li_attr' cellpadding='0' cellspacing='0' border='0'>" +
                          ...
                          "<tr><td>是否加粗：</td><td><input type='radio' name='normal" + i + "' value='normal' />正常 <input type='radio' name='normal" + i + "' value='blod' />加粗</td></tr>" +
                      "</table>" +
				  "</div>";
    $(divhtml).appendTo(".attribute_frame");
}
...
function tpAttr() {
    var divhtml = "<div id='addAttr" + i + "' class='addAttr' i='" + i + "'>" +
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>" +
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='mode" + i + "' value='two' checked='checked' />一行一张</td><td><input type='radio' name='mode" + i + "' value='three' />一行两张</td><td><input type='radio' name='mode" + i + "' value='four' />一行三张</td><td><input type='radio' name='mode" + i + "' value='five' />一行四张</td></tr>" +
...
function splbAttr() {
    var divhtml = "<div id='addAttr" + i + "' class='addAttr' i='" + i + "'>" +
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>" +
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='composition" + i + "' value='manner1' checked='checked' />小图</td><td><input type='radio' name='composition" + i + "' value='manner2' />大图</td><td><input type='radio' name='composition" + i + "' value='manner3'/>列表</td><td><input type='radio' name='composition' value='manner4' />一大两小</td></tr>" +
...
function spAttr() {
    var divhtml = "<div id='addAttr" + i + "' class='addAttr' i='" + i + "'>" +
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>" +
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='composition" + i + "' value='manner1' checked='checked' />小图</td><td><input type='radio' name='composition" + i + "' value='manner2' />大图</td><td><input type='radio' name='composition" + i + "' value='manner3'/>列表</td><td><input type='radio' name='composition" + i + "' value='manner4' />一大两小</td></tr>" +
					  "</table>" +
...
//图片布局框模块--------图片布局框模块--------图片布局框模块
function bj() {
    var divhtml = "<div id='module" + i + "' i='" + i + "' name='BuJu' class='small tp'>" +
					  "<ul class='bjkj1'>" +
					  "</ul>" +
				  "</div>";
    $(divhtml).appendTo(".gridly");
...
function bjAttr() {
    var divhtml = "<div id='addAttr" + i + "' class='addAttr' i='" + i + "'>" +
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>" +
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='bjkj" + i + "' value='one' checked='checked' />一大两小</td><td><input type='radio' name='bjkj" + i + "' value='two' />两小一大</td></tr>" +
						  //"<tr><td align='right'>显示文字：</td><td><input type='radio' name='txt" + i + "' value='yes' checked='checked' />是</td><td><input type='radio' name='txt" + i + "' value='no' />否</td><td></td></tr>" +
					  "</table>" +
					  "<p class='increase' onclick='addTPbj(this)'>增加</p>" +
				  "</div>";
    $(divhtml).appendTo(".attribute_frame");
}
function addTPbj(e) {
    ...
    var divhtml = "<li id='nav_li" + n + "' n='" + n + "'><a href><img src='img/banner.png'/></a></li>";
    $(divhtml).appendTo("#module" + m + " ul");
    var htmldiv = "<table id='nav_li_attr" + n + "' class='nav_li_attr' n='" + n + "' cellpadding='0' cellspacing='0' border='0'>" +
					  "<tr><td>图片:</td><td width='238px'><button onclick='chooseImg(this,\"TuPian\")' type='button' >选择图片</button></td><td><div class='changeBtn'><span onclick='moveUp(this," + n + ")'>上移</span><span onclick='moveDwon(this," + n + ")'>下移</span><span onclick='moveDel(this," + n + ")'>删除</span></div></td></tr>" +
					  "<tr><td></td><td><img src='img/banner.png'/></td></tr>" +
