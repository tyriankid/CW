        ...
        $(".gridly").children("div").each(function () {
            ...
            switch (modelName) {
                ...
                case "GunDong":
                    ...
                    res += "●";                                                            //|显示个数|
                    //***********************内容开始***********************                  |显示内容|
                    res += $(this).find("#scroll_begin a").html().rep() + "♦" + $(this).find("#scroll_begin a").css("color") + "♦" + $(this).find("#scroll_begin a").attr("href") + "♦" + $(this).find("#scroll_begin a").attr("class");
                    //***********************内容结束*********************** 
                    break;
                case "TuPian":
                    res += "●";//                                                             |高度|
    ...
    $(".gridly").children("div").each(function () {
        ...
        switch (modelName) {
            ...
            case "GunDong":
                ...
                if (!$(this).find("#scroll_begin a").hasClass("bStyle") && !$(this).find("#scroll_begin a").hasClass("nStyle")) {
                    msgStr += "滚动公告的字体不能为空~<br/>";
                }
                break;
            case "TuPian":
