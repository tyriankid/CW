...
function dhAttrBind(t) {
    ...
    var divhtml = "<div id='addAttr" + t + "' class='addAttr' i='" + t + "'>" +
                      ...
                      "<tr><td align='right'>显示方式：</td><td><input type='radio' name='way" + t + "' value='two' />一行两列</td><td><input type='radio' name='way" + t + "' value='three' />一行三列</td><td><input type='radio' name='way" + t + "' value='four'  />一行四列</td><td><input type='radio' name='way" + t + "' value='five'  />一行五列</td></tr></tr>" +
    ...
    if ($("#module" + t).find("ul").is(".dh_style5"))
    {
        //alert("导航：" + $("#addAttr" + t + " input[value='five']").length)
        $("#addAttr" + t + " input[value='five']").attr("checked", "checked");
    }
    else if ($("#module" + t).find("ul").is(".dh_style4")) {
...
function gdAttrBind(t) {
    ...
    var atxt = $("#module" + t + " .wb_txt a").html().trim();
    var divhtml = "<div id='addAttr" + t + "' class='addAttr' i='" + t + "'>" +
					  "<table class='nav_li_attr' cellpadding='0' cellspacing='0' border='0'>" +
                          ...
                          "<tr><td>是否加粗：</td><td><input type='radio' name='normal" + t + "' value='normal' />正常 <input type='radio' name='normal" + t + "' value='blod' />加粗</td></tr>" +
					  "</table>" +
				  "</div>";
    $(divhtml).appendTo(".attribute_frame");
    if ($("#gongao").find("a").hasClass("nStyle")) {
        $("#addAttr" + t + " input[value='normal']").attr("checked", "checked");
    } else {
        $("#addAttr" + t + " input[value='blod']").attr("checked", "checked");
    }
    ScrollImgLeft();
}
//图片数据绑定
function tpAttrBind(t) {
    ...
    var divhtml = "<div id='addAttr" + t + "' class='addAttr' i='" + t + "'>" +
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>" +
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='mode" + t + "' value='two' />一行一张</td><td><input type='radio' name='mode" + t + "' value='three' />一行两张</td><td><input type='radio' name='mode" + t + "' value='four' />一行三张</td><td><input type='radio' name='mode" + t + "' value='five' />一行四张</td></tr>" +
    ...
    if ($("#module" + t).find("ul").is(".tp_style1")) {
        ...
        $("#addAttr" + t + " input[value='three']").attr("checked", "checked");
    } else if ($("#module" + t).find("ul").is(".tp_style3")) {
        $("#addAttr" + t + " input[value='four']").attr("checked", "checked");
    } else {
        $("#addAttr" + t + " input[value='five']").attr("checked", "checked");
    }
...
//图片布局框数据绑定
function bjAttrBind(t) {
    n = 1;
    var divhtml = "<div id='addAttr" + t + "' class='addAttr' i='" + t + "'>" +
					  "<table class='nature' cellpadding='0' cellspacing='0' border='0'>" +
						  "<tr><td align='right'>显示方式：</td><td><input type='radio' name='bjkj" + t + "' value='one' />一大两小</td><td><input type='radio' name='bjkj" + t + "' value='two' />一小两大</td></tr>" +
						  //"<tr><td align='right'>显示文字：</td><td><input type='radio' name='txt" + t + "' value='yes' />是</td><td><input type='radio' name='txt" + t + "' value='no' />否</td><td></td></tr>" +
					  "</table>" +
					  "<p class='increase' onclick='addTPbj(this)'>增加</p>" +
				  "</div>";
    $(divhtml).appendTo(".attribute_frame");
    if ($("#module" + t).find("ul").is(".bjkj1")) {
