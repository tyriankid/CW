<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="activateMember.aspx.cs" Inherits="Hidistro.UI.Web.Admin.activateMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        <div class="title">
            ...
            <h1>复购会员列表</h1>
            <span>微会员信息在原始会员中存在并且购买过商品。</span>
        </div>
        <!--搜索-->
                ...
                <div class="batchHandleArea" style="display: none">
                    ...
                    <dl id="dlExcel" style="display: none;">
                        <ul>
                            <li style="width: 135px;"></li>
                            <li>
                                <asp:Button ID="btnExcelPrint" runat="server" CssClass="submit_queding" Text="确认导入" /></li>
                        </ul>
                    </dl>
                </div>
