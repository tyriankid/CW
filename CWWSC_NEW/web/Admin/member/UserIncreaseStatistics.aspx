...
<div class="title">
  ...
  <span>会员增长报表查询</span>
	      ...
	      <div class="datalist">
	        ...
	        <div class="searcharea clearfix search_clear ">
            ...
            <div class="searcharea clearfix search_clear">
	          <ul class="a_none_left">
	            <li><span class="colorG">按月查看认证门店增长( <strong><asp:Literal ID="litStoreOfMonth" runat="server" ></asp:Literal></strong> )</span> </li>
	            <li> <abbr class="formselect">
	              <Hi:YearDropDownList ID="drpStoreYearOfMonth" runat="server" />
	              </abbr> </li>
	            <li> <abbr class="formselect">
	             <Hi:MonthDropDownList ID="drpStoreMonthOfMonth" runat="server" />
	              </abbr> </li>
	            <li>
	               <asp:Button ID="btnStoreOfMonth" runat="server" class="searchbutton" Text="查询"/>
                </li>
              </ul>
            </div>
	        <div class="Pg_8 Pg_20"><img id="imgStoreChartOfMonth" runat="server" style=" border-width:1px; border-style:solid; border-color:#e3e7ea;" /></div>
