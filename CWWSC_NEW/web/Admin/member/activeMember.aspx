<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="activeMember.aspx.cs" Inherits="Hidistro.UI.Web.Admin.activeMember" %>
		  ...
		  <div class="batchHandleArea" style="display:none">
		    ...
		    <UI:Grid ID="grdMemberList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="UserId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                      ...
                      <%--  <asp:TemplateField HeaderText="会员卡号" ItemStyle-Width="60px" HeaderStyle-CssClass="td_right td_left" ShowHeader="true">
                        ...
                        <asp:BoundField HeaderText=" 积分点数" DataField="Points" SortExpression="Points" />
                            <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="border_top border_bottom" HeaderStyle-Width="150" >
