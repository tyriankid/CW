<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NianXingMember.aspx.cs" Inherits="Admin_member_NianXingMember" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="dataarea mainwidth databody">
  ...
  <h1>粘性会员列表</h1>
  <span>对粘性会员进行管理，也可以修改会员资料和导出会员</span>
</div>
		<!--搜索-->
      ...
      <ul>
        ...
        <li>
          <asp:Button ID="btnSearchButton" runat="server" Text="查询" CssClass="searchbutton"/>
           ...
           <li class="clickTopX" onclick="addnianxingMember()" style="display:none">添加粘性会员</li>
          <li id="clickTopDown" class="clickTopX">导出粘性会员</li>
      </ul>
    ...
    <UI:Grid ID="grdMember" runat="server" AutoGenerateColumns="False"  ShowHeader="true" DataKeyNames="id" GridLines="None"
                   HeaderStyle-CssClass="table_title"  SortOrderBy="UserName" SortOrder="ASC" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="门店名称" SortExpression="accountALLHere" ItemStyle-Width="300px" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="详细地址" SortExpression="address" ItemStyle-Width="380px" HeaderStyle-CssClass="td_right td_left">
                         ...
                         <asp:TemplateField HeaderText="消费" SortExpression="Price" ItemStyle-Width="80px" HeaderStyle-CssClass="td_right td_left">
                            <ItemTemplate>
	                                <asp:Label ID="Price" runat="server" Text='<%# Bind("Price","{0:F2}") %>'></asp:Label>      
                            </ItemTemplate>
                        </asp:TemplateField>   
                         ...
                         <ItemStyle CssClass="spanD spanN" />
                             <ItemTemplate>
                                 <span class="submit_bianji"><a href='<%# Globals.GetAdminAbsolutePath("/member/AddNianxingMember.aspx?Id=" + Eval("id"))%> '>编辑</a></span>
     ...
     <script type="text/javascript">
         function addnianxingMember() {

             location.href = "AddNianxingMember.aspx";
         }
