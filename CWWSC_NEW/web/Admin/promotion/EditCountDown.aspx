...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator5" style="padding-left:15px;">      
        ...
        <ul>
        <li></li>
        <li><span class="formitemtitle Pw_128">限时抢购商品：</span>
      ...
      <li class="li_pa_left">
         <asp:Button ID="btnUpdateCountDown" runat="server" Text="修  改" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding"  />
         </li>
        </ul>
      </div>
