        ...
        <div class="formitem validator2">
          <ul>
            <li><span class="formitemtitle Pw_110"><em >*</em>礼品名称：</span>
              ...
              <span style="display:none"><input type="checkbox" id="chkPromotion" runat="server" />是否参与促销赠送</span>
            ...
            <li class="m_none"><span class="formitemtitle Pw_110">礼品图片：</span>
              ...
              <li class="clearfix"><span class="formitemtitle Pw_110">礼品库存：</span>
             <asp:TextBox ID="txtStock" runat="server" CssClass="forminput"></asp:TextBox>
             <p id="P1"></p>             
            </li>
...
appendValid(new NumberRangeValidator('ctl00_contentHolder_txtNeedPoint', 0, 1000000, '兑换所需积分不能为空，大小0-1000000之间'));
