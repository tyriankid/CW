<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditCutDown.aspx.cs" Inherits="Hidistro.UI.Web.Admin.EditCutDown" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator5" style="padding-left:15px;">      
        ...
        <li><span class="formitemtitle Pw_128">砍价商品：</span>
          ...
          <UI:WebCalendar runat="server" CssClass="forminput" ID="calendarStartDate" /><abbr class="formselect"><Hi:HourDropDownList ID="dropStartHours" runat="server" style=" margin-left:5px;"/></abbr>
          ...
          <UI:WebCalendar runat="server" CssClass="forminput" ID="calendarEndDate" /><abbr class="formselect"><Hi:HourDropDownList ID="dropEndHours" runat="server" style=" margin-left:5px;"/></abbr>
          ...
          <li><span class="formitemtitle Pw_128"><em >*</em>限购总数量：</span>
           ...
           <p id="ctl00_contentHolder_TxtCountTip">此次活动可购买的商品总数量,不能为空,订购达到此上限时，活动会自动变为结束状态。</p>
          </li>
          <li><span class="formitemtitle Pw_128"><em >*</em>最大被砍价数：</span>
           ...
           <p id="ctl00_contentHolder_TxtMaxCountTip">此次活动可被砍价的总数量,不能为空,砍价达到此上限时，无法继续被砍价。</p>
          </li>
          <li><span class="formitemtitle Pw_128"><em >*</em>每次砍价金额：</span>
           ...
           <p id="ctl00_contentHolder_TxtPerCutPriceTip">此次活动每次砍价减少的金钱数量</p>
          </li>
        <li><span class="formitemtitle Pw_128"><em >*</em>起始金额：</span>
           ...
           <p id="ctl00_contentHolder_TxtCurrentPriceTip">此次活动商品的起始价格,不能为空。</p>
          </li>
          <li><span class="formitemtitle Pw_128"><em >*</em>最低金额：</span>
            <asp:TextBox ID="TxtMinPrice" runat="server" CssClass="forminput"></asp:TextBox>
           <p id="ctl00_contentHolder_TxtMinPriceTip">此次活动商品最低的价格,不能为空,砍价超过此底线时，无法继续被砍价。</p>
          </li>
         ...
         <li>
	       <span class="formitemtitle Pw_128">活动说明：</span>
             <abbr class="formselect">
                   <Kindeditor:KindeditorControl ID="txtContent" runat="server" Width="530px" Height="200px" />
             </abbr> 
      ...
      <li  class="li_pa_left">
         <asp:Button ID="btnUpdateCutDown" runat="server" Text="修改" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding float"  />
         </li>
        </ul>
      </div>
 ...
 <script type="text/javascript" src="groupbuy.helper.js"></script>
  <script type="text/javascript" language="javascript">
      function InitValidators() {
          ...
          initValid(new InputValidator('ctl00_contentHolder_TxtMaxCount', 1, 10, false, '-?[0-9]\\d*', '数据类型错误，最大被砍价数只能输入整数型数值'))
          appendValid(new NumberRangeValidator('ctl00_contentHolder_TxtMaxCount', 1, 9999999, '输入的数值超出了系统表示范围'));

          initValid(new InputValidator('ctl00_contentHolder_TxtPerCutPrice', 1, 10, false, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，每次砍价金额只能输入数值'))
          appendValid(new NumberRangeValidator('ctl00_contentHolder_TxtPerCutPrice', 1, 9999999, '输入的数值超出了系统表示范围'));

          initValid(new InputValidator('ctl00_contentHolder_TxtCurrentPrice', 1, 10, false, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，起始金额只能输入数值'))
          appendValid(new NumberRangeValidator('ctl00_contentHolder_TxtCurrentPrice', 1, 9999999, '输入的数值超出了系统表示范围'));

          initValid(new InputValidator('ctl00_contentHolder_TxtMinPrice', 1, 10, false, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '数据类型错误，最低价格只能输入数值'))
          appendValid(new NumberRangeValidator('ctl00_contentHolder_TxtMinPrice', 1, 9999999, '输入的数值超出了系统表示范围'));
      }
      $(document).ready(function () {
          ...
          $.ajax({
              ...
              data:
                      {
                          isCallback: "true",
                          productId: $("#ctl00_contentHolder_dropCutDownProduct").val()
                      },
