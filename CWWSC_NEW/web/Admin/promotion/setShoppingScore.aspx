...
<div class="dataarea mainwidth databody">
      ...
      <div class="datafrom">
          <div class="formitem validator1">
              <ul>
                  <li><span class="formitemtitle Pw_198"><em >*</em>店长几元一积分：</span>
                  ...
                  <li><span class="formitemtitle Pw_198"><em >*</em>普通会员几元一积分：</span>
                      <asp:TextBox Id="txtProductPointSetPt" runat="server" CssClass="forminput"></asp:TextBox>
                      <p id="txtProductPointSetPtTip" runat="server">几元一积分不能为空,必须在0.1-10000000之间</p>
                  </li>
              </ul>
...
<script>
    function InitValidators() {
        ...
        initValid(new InputValidator('ctl00_contentHolder_txtProductPointSetPt', 1, 10, false, '(0|(0+(\\.[0-9]{1,2}))|[1-9]\\d*(\\.\\d{1,2})?)', '几元一积分不能为空,必须在0.1-10000000之间'))
        appendValid(new MoneyRangeValidator('ctl00_contentHolder_txtProductPointSetPt', 0.1, 10000000, '几元一积分必须在0.1-10000000之间'));
    }
