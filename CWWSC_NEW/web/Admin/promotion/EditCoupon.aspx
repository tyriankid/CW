...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator2">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">满足金额: <em >*</em></span>
          ...
          <li> <span class="formitemtitle Pw_100">可抵扣金额：<em >*</em></span>
           ...
           <p id="ctl00_contentHolder_txtDiscountValueTip"></p>
              ...
              <li id="szSelectStore">
                <span class="formitemtitle Pw_100">优惠券门店：<em >*</em></span>
                <asp:DropDownList ID="DDLservice" runat="server"></asp:DropDownList>
                <p id="P2">优惠券门店</p>
            </li>
            <li id="szSelectType">
                <span class="formitemtitle Pw_100">优惠券品类：<em >*</em></span>
    ...
    <input type="hidden" runat="server" id="hidIsSanZuo" clientidmode="Static" value="0" />
