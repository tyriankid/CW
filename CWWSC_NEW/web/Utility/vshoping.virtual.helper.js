...
function submmitorder() {
    ...
    $.ajax({
        ...
        type: 'post', dataType: 'json', timeout: 10000,
        data: {
            action: "Submmitordervirtual", distributorId: DisId, shipDistributorId: $('#distributorSelect').val(), shippingType: $("#selectShippingType").val(), paymentType: $("#selectPaymentType").val(), couponCode: $("#selectCoupon").val(), redpagerid: $("#selectRedPager").val(), shippingId: $('#selectShipTo').val(), receiptId: $('#selectReceipt').val(),
