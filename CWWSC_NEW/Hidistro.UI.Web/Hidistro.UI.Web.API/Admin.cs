...
namespace Hidistro.UI.Web.API
{
    public class Admin : IHttpHandler
    {
        ...
        public void ProcessNewOrders(HttpContext context)
        {
            ...
            SalesHelper.GetNewlyOrdersCountAndPayCount(now, out ordersCount, out payCount, out refundOrderCount, out replacementOrderCount, out returnsOrderCount, isSupplier, isStoreId, currentManager.ClientUserId);
            this.jsondict.Clear();
