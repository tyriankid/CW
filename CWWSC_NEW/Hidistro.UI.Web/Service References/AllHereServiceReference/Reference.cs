...
namespace Hidistro.UI.Web.AllHereServiceReference {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://jlinterface.jlserver", ConfigurationName="AllHereServiceReference.MPFTOJL")]
    public interface MPFTOJL {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(Style=System.ServiceModel.OperationFormatStyle.Rpc, SupportFaults=true, Use=System.ServiceModel.OperationFormatUse.Encoded)]
        void UpAHDJState(string JSONXML, string sTableName);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface MPFTOJLChannel : Hidistro.UI.Web.AllHereServiceReference.MPFTOJL, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MPFTOJLClient : System.ServiceModel.ClientBase<Hidistro.UI.Web.AllHereServiceReference.MPFTOJL>, Hidistro.UI.Web.AllHereServiceReference.MPFTOJL {
        ...
        public void AH_TO_MPF_TIMER() {
            base.Channel.AH_TO_MPF_TIMER();
        }
        
        public void AH_TO_MPF() {
            base.Channel.AH_TO_MPF();
        }
        
        public void MPFTOJL_KHXX() {
            base.Channel.MPFTOJL_KHXX();
        }
        
        public void MPFTOJL_FGS() {
            base.Channel.MPFTOJL_FGS();
        }
        
        public void MPFTOJL_BM_Market() {
            base.Channel.MPFTOJL_BM_Market();
        }
        
        public void MPFTOJL_GYS() {
            base.Channel.MPFTOJL_GYS();
        }
        ...
        public void UpAHDJState(string JSONXML, string sTableName) {
            base.Channel.UpAHDJState(JSONXML, sTableName);
        }
    }
}
