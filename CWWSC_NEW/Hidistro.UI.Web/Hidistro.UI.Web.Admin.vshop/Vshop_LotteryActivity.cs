			...
			else
			{
				...
				if (this.fileUpload.HasFile)
				{
					try
					{
						...
						{
							this.ShowMsg("请选择活动开始时间精确到小时", false);
						}
						else
						{
							if (!this.calendarEndDate.SelectedDate.HasValue)
							{
								this.ShowMsg("请选择活动结束时间精确到小时", false);
							}
							else
							{
								int num;
								...
								else
								{
									...
									if (int.TryParse(this.txtPrize1Num.Text, out num2) && int.TryParse(this.txtPrize2Num.Text, out num2) && int.TryParse(this.txtPrize3Num.Text, out num2))
									{
										...
										if (num9 > 0)
										{
                                            ...
                                            reply.ReplyType = ReplyType.Wheel;//ReplyType.Keys;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (int.TryParse(base.Request.QueryString["type"], out this.type))
			{
				...
				case 3:
					...
					break;
                case 6:
                    this.LitTitle.Text = "拆礼盒活动";
                    this.Litdesc.Text = "拆礼盒活动";
                    break;
                case 9:
                    this.LitTitle.Text = "微信红包活动";
                    this.Litdesc.Text = "微信红包活动";
                    break;
				}
			}
			else
