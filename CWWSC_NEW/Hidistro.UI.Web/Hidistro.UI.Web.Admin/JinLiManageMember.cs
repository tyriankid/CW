...
{
    public class JinLiManageMember : AdminPage
    {
        protected System.Web.UI.WebControls.Button btnSearchButton;
        protected Grid grdMember;
        protected Pager pager;
        protected Pager pager1;
        protected System.Web.UI.WebControls.TextBox txtSearchText;
        protected System.Web.UI.WebControls.Button btnExport;
        protected ExportFieldsCheckBoxList4 exportFieldsCheckBoxList;
        private void BindData()
        {
            ...
            DbQueryResult members = CWMembersHelper.GetListMember(memberQuery);
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                this.grdMember.SortOrderBy = "UserName";
                this.BindData();
            }
        }
        ...
        private void btnExport_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                //得到待导出的数据集
                System.Data.DataTable allHereMember = CWMembersHelper.GetExportCwMemberByQuery(query, fields);

                string strPath = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "Resources\\xls\\managemembersxls\\金力会员信息" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
