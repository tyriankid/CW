...
namespace Hidistro.UI.Web.Admin
{
	...
	public class UserIncreaseStatistics : AdminPage
	{
        ...
        protected System.Web.UI.WebControls.Button btnStoreOfMonth;
        protected YearDropDownList drpStoreYearOfMonth;
        protected MonthDropDownList drpStoreMonthOfMonth;
        protected System.Web.UI.HtmlControls.HtmlImage imgStoreChartOfMonth;
        protected System.Web.UI.WebControls.Literal litStoreOfMonth;
		...
		private void BindDaysAddUser()
		{
            ...
            this.imgChartOfSevenDay.Src = Globals.ApplicationPath + string.Format("/UserStatisticeChart.aspx?ChartType={0}&XValues={1}&YValues={2}&Width=1000", "bar", str, str2);
		}
		...
		private void BindMonthAddUser()
		{
            ...
            this.imgChartOfMonth.Src = Globals.ApplicationPath + string.Format("/UserStatisticeChart.aspx?ChartType={0}&XValues={1}&YValues={2}&Width=1000", "bar", str, str2);
		...
		private void BindYearAddUser()
		{
            ...
            this.imgChartOfYear.Src = Globals.ApplicationPath + string.Format("/UserStatisticeChart.aspx?ChartType={0}&XValues={1}&YValues={2}&Width=1000", "bar", str, str2);
        ...
        /// 认证门店增长
        /// </summary>
        private void BindMonthAddDistributors()
        {
            System.Collections.Generic.IList<UserStatisticsForDate> list = SalesHelper.GetDistributorsAdd(new int?(this.drpStoreYearOfMonth.SelectedValue), new int?(this.drpStoreMonthOfMonth.SelectedValue), null);
            string str = string.Empty;
            string str2 = string.Empty;
            foreach (UserStatisticsForDate date in list)
            {
            ...
            this.imgStoreChartOfMonth.Src = Globals.ApplicationPath + string.Format("/UserStatisticeChart.aspx?ChartType={0}&XValues={1}&YValues={2}&Width=1000", "bar", str, str2);
            this.litStoreOfMonth.Text = this.drpStoreYearOfMonth.SelectedValue.ToString(System.Globalization.CultureInfo.InvariantCulture) + "年" + this.drpStoreMonthOfMonth.SelectedValue.ToString(System.Globalization.CultureInfo.InvariantCulture) + "月";
        }
        ...
        //增长门店统计
        private void btnStoreOfMonth_Click(object sender, System.EventArgs e)
        {
            this.BindMonthAddDistributors();
        }
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            this.btnStoreOfMonth.Click += new System.EventHandler(this.btnStoreOfMonth_Click);
