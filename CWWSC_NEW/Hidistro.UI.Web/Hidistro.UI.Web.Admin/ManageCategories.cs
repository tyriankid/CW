...
namespace Hidistro.UI.Web.Admin
{
    ...
    public class ManageCategories : AdminPage
    {
        ...
        {
            if (CustomConfigHelper.Instance.IsQipinhui)//如果是齐品汇的特殊返佣机制,则给出对分类的配置返佣的功能
            {
                ViewState["IsQipinhui"] = true;
            }
            else
            {
                ViewState["IsQipinhui"] = false;
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        categoryInfo.SecondCommission = "0";
                        categoryInfo.ThirdCommission = "0";
                    }
