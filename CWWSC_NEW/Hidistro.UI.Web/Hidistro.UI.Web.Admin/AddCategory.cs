...
namespace Hidistro.UI.Web.Admin
{
	...
	public class AddCategory : AdminPage
	{
		...
		private CategoryInfo GetCategory()
		{
            ...
            if (!string.IsNullOrEmpty(this.dropCategories.SelectedValue.ToString()))
            {
                Response.Write("<script > alert(" + dropCategories.SelectedValue + "); </script>");
                //return null;
			...
			CategoryInfo target = new CategoryInfo
			{
                ...
                //2015-8-19 ParentCategoryId = this.dropCategories.SelectedValue, 改为直接等于0
				ParentCategoryId = 0,
            ...
            if (string.IsNullOrEmpty(this.txtfirst.Text))//|| string.IsNullOrEmpty(this.txtsecond.Text) || string.IsNullOrEmpty(this.txtthird.Text) string.IsNullOrEmpty(this.txtseoncdtoone.Text) || string.IsNullOrEmpty(this.txtthirdtoone.Text) ||  string.IsNullOrEmpty(this.txtsecondtothree.Text) || )
			{
