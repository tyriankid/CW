...
namespace Hidistro.UI.Web.Admin
{
	...
	public class OrderDetails : AdminPage
	{
        ...
        protected Order_Receipt Receipt;
		...
		private void LoadUserControl(OrderInfo order)
		{
            ...
            this.Receipt.ReceiptId = order.receiptId;
		}
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			else
			{
				...
				if (!this.Page.IsPostBack)
				{
                    ...
                    {
                        string strRealModeName = (this.order.RealModeName != null) ? this.order.RealModeName : "";
                        if (strRealModeName.IndexOf("自提") > -1 || (strRealModeName == "" && this.order.ModeName != null && this.order.ModeName.IndexOf("自提") > -1))
                            this.lkbtnSendGoods.Visible = false;
                    }
