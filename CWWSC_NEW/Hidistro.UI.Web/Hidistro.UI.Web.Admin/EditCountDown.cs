    ...
    public class EditCountDown : AdminPage
    {
        ...
        private void btnUpdateGroupBuy_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (DateTime.Compare(this.calendarStartDate.SelectedDate.Value.AddHours((double)this.dropStartHours.SelectedValue.Value).AddMinutes((double)this.dropStartMinute.SelectedValue.Value), countDownInfo.EndDate) >= 0)
                {
        ...
        private void LoadCountDown(CountDownInfo countDownInfo)
        {
            ...
            this.dropEndHours.SelectedValue = new int?(countDownInfo.EndDate.Hour);
            this.dropEndMinute.SelectedValue = new int?(countDownInfo.EndDate.Minute);

            this.calendarStartDate.SelectedDate = new DateTime?(countDownInfo.StartDate.Date);
            this.dropStartHours.SelectedValue = new int?(countDownInfo.StartDate.Hour);
            this.dropStartMinute.SelectedValue = new int?(countDownInfo.StartDate.Minute);
