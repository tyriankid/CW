...
namespace Hidistro.UI.Web.Admin
{
    ...
    public class activateMember : AdminPage
    {
        ...
        private void btnExport_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                string strPath = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "Resources\\xls\\activatememberxls\\激活用户信息" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
                ...
                //{
                //    this.Page.Response.AppendHeader("Content-Disposition", "attachment;filename=激活用户信息.csv");
                //    this.Page.Response.ContentType = "application/octet-stream";
                //}
                //else
                //{
                //    this.Page.Response.AppendHeader("Content-Disposition", "attachment;filename=激活用户信息.txt");
