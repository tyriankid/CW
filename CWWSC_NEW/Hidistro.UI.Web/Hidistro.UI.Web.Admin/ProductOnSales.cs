	...
	public class ProductOnSales : AdminPage
	{
		...
		private void BindProducts()
		{
            ...
            ProductQuery entity = new ProductQuery
            {
                ...
                ProductSource = 1,//商品来源，1为创维、2为供应商  这里如果是供应商则显示供应商商品，如果是平台管理员则显示创维与供应商的商品
                SupplierId = 0
            };
        ...
        //    {
        //        string savepath = System.Web.HttpContext.Current.Server.MapPath("~/Storage/TicketImage") + "\\" + string.Format("product_{0}", productId) + ".jpg";
        //        string productShowUrl = Globals.HostPath(HttpContext.Current.Request.Url) + "/Vshop/ProductDetails.aspx?ProductId=" + productId;
        //        string url = "/API/GetQRCode.ashx?code=" + productShowUrl;
