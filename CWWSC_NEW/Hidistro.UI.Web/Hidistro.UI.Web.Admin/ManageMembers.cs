...
namespace Hidistro.UI.Web.Admin
{
    ...
    public class ManageMembers : AdminPage
    {
        ...
        private string userTypeId;//会员类型Id
        ...
        protected System.Web.UI.WebControls.DropDownList ddlUserType;//会员类型
        ...
        protected void BindData()
        {
            ...
            MemberQuery query = new MemberQuery
            {
                ...
                DistributorsUserIds = isFiliale ? getStorIds(currentManager.ClientUserId) : isStore ? currentManager.ClientUserId.ToString() : ""
            };
        ...
        private void btnExport_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                string strPath = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "Resources\\xls\\managemembersxls\\用户信息" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
                //ExcelDBClass excelDBClass = new ExcelDBClass(strPath, true);
                ExcelDBClass exls = new ExcelDBClass(strPath, false);
                DataSet ds = new DataSet();
                ds.Tables.Add(membersNopage.Copy());
                ds.Tables[0].TableName = "用户信息";
                ...
                //{
                //    this.Page.Response.AppendHeader("Content-Disposition", "attachment;filename=用户信息.csv");
                //    this.Page.Response.ContentType = "application/octet-stream";
                //}
                //else
                //{
                //    this.Page.Response.AppendHeader("Content-Disposition", "attachment;filename=用户信息.txt");
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            foreach (System.Web.UI.WebControls.GridViewRow row in this.grdMemberList.Rows)
                            {
                                ...
                                if (box.Checked)
                                {
                                    string str6 = ((System.Web.UI.DataBoundLiteralControl)row.Controls[3].Controls[0]).Text.Trim().Replace("<div></div>", "");
        ...
        private void grdMemberList_RowDeleting(object sender, System.Web.UI.WebControls.GridViewDeleteEventArgs e)
        {
            ...
            if (DistributorsBrower.GetDistributorInfo(userId) == null)
            {
        ...
        private void lkbDelectCheck_Click(object sender, System.EventArgs e)
        {
            ...
            {
                System.Web.UI.WebControls.CheckBox box = (System.Web.UI.WebControls.CheckBox)row.FindControl("checkboxCol");
                int userid = System.Convert.ToInt32(this.grdMemberList.DataKeys[row.RowIndex].Value);
                if (DistributorsBrower.GetDistributorInfo(userid) == null)
                {
                    if (box.Checked && MemberHelper.Delete(userid))
                    {
                        num++;
                    }
                }
            ...
            if (num == 0)
            {
                this.ShowMsg("请先选择要删除的会员账号，掌柜无法删除。", false);
            }
            else
            {
                this.BindData();
        ...
        private void LoadParameters()
        {
            if (!this.Page.IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(this.Page.Request.QueryString["userTypeId"]))
                {
                    this.userTypeId = base.Server.UrlDecode(this.Page.Request.QueryString["userTypeId"]);
                }
                this.rankList.SelectedValue = this.rankId;
                this.txtSearchText.Text = this.searchKey;
                this.txtRealName.Text = this.realName;
                this.ddlUserType.SelectedValue = this.userTypeId;
            }
            else
            {
                ...
                this.userTypeId = this.ddlUserType.SelectedValue;
            }
        }
        ...
        private void ReBind(bool isSearch)
        {
            ...
            queryStrings.Add("userTypeId", this.ddlUserType.SelectedValue);
