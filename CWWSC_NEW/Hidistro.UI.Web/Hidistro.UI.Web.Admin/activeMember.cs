...
namespace Hidistro.UI.Web.Admin
{
    ...
    public class activeMember : AdminPage
    {
        ...
        private void btnExport_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                string strPath = System.AppDomain.CurrentDomain.SetupInformation.ApplicationBase + "Resources\\xls\\activememberxls\\活跃用户" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
                ...
                //{
                //    this.Page.Response.AppendHeader("Content-Disposition", "attachment;filename=活跃用户.csv");
                //    this.Page.Response.ContentType = "application/octet-stream";
                //}
                //else
                //{
                //    this.Page.Response.AppendHeader("Content-Disposition", "attachment;filename=活跃用户.txt");
