...
namespace Hidistro.UI.Web.Admin
{
	...
	public class SetOrderOption : AdminPage
	{
        ...
        protected System.Web.UI.WebControls.TextBox txtTakeGoodsDays;//确认收货后几天允许发起申请
        protected System.Web.UI.HtmlControls.HtmlGenericControl txtTakeGoodsDaysTip;//提示
		...
		protected void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			decimal dnum5;
            //decimal dnum6;
            if (this.ValidateValues(out inum, out inum2, out inum3, out inum4, out dnum5))
			{
				SiteSettings masterSettings = SettingsManager.GetMasterSettings(false);
                //masterSettings.freeShippingAmount = dnum6;
				masterSettings.OrderShowDays = inum;
				masterSettings.CloseOrderDays = inum2;
				masterSettings.FinishOrderDays = inum3;
                masterSettings.TakeGoodsDays = inum4;
				masterSettings.TaxRate = dnum5;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (!this.Page.IsPostBack)
			{
                ...
                this.txtTakeGoodsDays.Text = masterSettings.TakeGoodsDays.ToString(System.Globalization.CultureInfo.InvariantCulture);
        ...
        private bool ValidateValues(out int showDays, out int closeOrderDays, out int finishOrderDays, out int takeGoodsDaysDays, out decimal taxRate)
		{
            ...
            if (!int.TryParse(this.txtTakeGoodsDays.Text, out takeGoodsDaysDays))
			{
				str += Formatter.FormatErrorMessage("收货后几天内允许发起退货申请不能为空,必须为正整数,范围在1-90之间");
			}
