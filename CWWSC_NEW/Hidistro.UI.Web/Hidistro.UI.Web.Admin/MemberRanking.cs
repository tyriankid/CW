...
namespace Hidistro.UI.Web.Admin
{
	...
	public class MemberRanking : AdminPage
	{
		...
		private void btnCreateReport_Click(object sender, System.EventArgs e)
		{
			...
			this.Page.Response.AppendHeader("Content-Disposition", string.Format("attachment;filename=会员消费排行{0}.csv",DateTime.Now.ToString("yyyyMMddHHmmss")));
		...
		private void LoadParameters()
		{
			if (!this.Page.IsPostBack)
			{
                ...
                if (!string.IsNullOrEmpty(this.Page.Request.QueryString["userType"]))
                {
                    this.userType = base.Server.UrlDecode(this.Page.Request.QueryString["userType"].ToString());
                }
                ...
                this.ddlUserType.SelectedValue = this.userType;
			...
			else
			{
                ...
                this.userType = this.ddlUserType.SelectedValue;
		...
		private void ReBind(bool isSearch)
		{
            ...
            queryStrings.Add("userType", this.ddlUserType.SelectedValue);
